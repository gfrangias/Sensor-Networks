...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7ff213dd4cf8, const void *arg_0x7ff213dd3020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7ff213d53618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7ff213b0a020), 
int (*key_eq_fn)(void *arg_0x7ff213b0a798, void *arg_0x7ff213b0aa38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7ff213906610, int arg_0x7ff213906878);
static double RandomUniform(void );
...
#line 238
  sim_log_debug(123U, "Packet", "Delivering packet to %i at %s\n", (int )sim_node(), sim_time_string());
...
static inline message_t *SRTreeC__RoutingReceive__receive(message_t *msg, void *payload, uint8_t len)
{
  ...
  sim_log_debug(77U, "SRTreeC", "### RoutingReceive.receive() start ##### \n");
  sim_log_debug(78U, "SRTreeC", "Something received!!!  from %u  %u\n", __nesc_ntoh_uint16(((RoutingMsg *)payload)->senderID.nxdata), msource);
#line 566
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 566
    {
...
#line 568
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(79U, "SRTreeC", "RoutingMsg enqueue failed!!! \n");
    }
  ...
  sim_log_debug(80U, "SRTreeC", "### RoutingReceive.receive() end ##### \n");
  return msg;
}
  ...
  if (isFull) 
    {
      ...
      sim_log_debug(278U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
...
static inline message_t *SRTreeC__NotifyReceive__receive(message_t *msg, void *payload, uint8_t len)
{
  ...
  sim_log_debug(73U, "SRTreeC", "### NotifyReceive.receive() start ##### \n");

  sim_log_debug(74U, "SRTreeC", "Something received!!!  from %u   %u \n", __nesc_ntoh_uint16(((NotifyParentMsg *)payload)->senderID.nxdata), msource);
#line 510
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 510
    {
...
#line 512
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(75U, "SRTreeC", "NotifyMsg enqueue failed!!! \n");
    }
  ...
  sim_log_debug(76U, "SRTreeC", "### NotifyReceive.receive() end ##### \n");
  return msg;
}
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7ff2134d3908, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7ff2134d3908) {
#line 78
    case 12:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7ff2134d3908, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7ff2134d1480, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7ff2134d1480, msg, payload, len);
#line 78
...
static inline void SimSchedulerBasicP__Scheduler__init(void )
{
  sim_log_debug(110U, "Scheduler", "Initializing scheduler.\n");
...
static inline void SRTreeC__sendRoutingTask__runTask(void )
{
  ...
  if (SRTreeC__RoutingSendQueue__empty()) 
    {
      sim_log_debug(82U, "SRTreeC", "sendRoutingTask(): Q is empty!\n");
  ...
  if (SRTreeC__RoutingSendBusy[sim_node()]) 
    {
      sim_log_debug(83U, "SRTreeC", "sendRoutingTask(): RoutingSendBusy= TRUE!!!\n");
  ...
  if (mlen != sizeof(RoutingMsg )) 
    {
      sim_log_debug(84U, "SRTreeC", "\t\tsendRoutingTask(): Unknown message!!!\n");
  ...
  if (sendDone == SUCCESS) 
    {
      sim_log_debug(85U, "SRTreeC", "sendRoutingTask(): Send returned success!!!\n");
    ...
    {
      sim_log_debug(86U, "SRTreeC", "send failed!!!\n");
    }
}
...
static inline void SRTreeC__sendNotifyTask__runTask(void )
{
  ...
  if (SRTreeC__NotifySendQueue__empty()) 
    {
      sim_log_debug(87U, "SRTreeC", "sendNotifyTask(): Q is empty!\n");
  ...
  if (SRTreeC__NotifySendBusy[sim_node()] == TRUE) 
    {
      sim_log_debug(88U, "SRTreeC", "sendNotifyTask(): NotifySendBusy= TRUE!!!\n");
  ...
  if (mlen != sizeof(NotifyParentMsg )) 
    {
      sim_log_debug(89U, "SRTreeC", "\t\t sendNotifyTask(): Unknown message!!\n");
  ...
  sim_log_debug(90U, "SRTreeC", " sendNotifyTask(): mlen = %u  senderID= %u \n", mlen, __nesc_ntoh_uint16(mpayload->senderID.nxdata));
  ...
  if (sendDone == SUCCESS) 
    {
      sim_log_debug(91U, "SRTreeC", "sendNotifyTask(): Send returned success!!!\n");
    ...
    {
      sim_log_debug(92U, "SRTreeC", "send failed!!!\n");
    }
}
...
static inline void SRTreeC__receiveRoutingTask__runTask(void )
{
  ...
  sim_log_debug(93U, "SRTreeC", "ReceiveRoutingTask(): len=%u \n", len);
  ...
  if (len == sizeof(RoutingMsg )) 
      ...
      if (SRTreeC__parentID[sim_node()] < 0 || SRTreeC__parentID[sim_node()] >= 65535) 
        {
          ...
          sim_log_debug(95U, "NotifyParentMsg", "receiveRoutingTask():NotifyParentMsg sending to node= %d... \n", SRTreeC__parentID[sim_node()]);
          ...
          if (SRTreeC__NotifySendQueue__enqueue(tmp) == SUCCESS) 
            {
              sim_log_debug(96U, "SRTreeC", "receiveRoutingTask(): NotifyParentMsg enqueued in SendingQueue successfully!!!\n");
          ...
          if (SRTreeC__curdepth[sim_node()] > __nesc_ntoh_uint8(mpkt->depth.nxdata) + 1 || __nesc_ntoh_uint16(mpkt->senderID.nxdata) == SRTreeC__parentID[sim_node()]) 
            {
              ...
              sim_log_debug(97U, "SRTreeC", "NotifyParentMsg sending to node= %d... \n", oldparentID);
              ...
              if ((oldparentID < 65535 || oldparentID > 0) || oldparentID == SRTreeC__parentID[sim_node()]) 
                {
                  ...
                  if (SRTreeC__NotifySendQueue__enqueue(tmp) == SUCCESS) 
                    {
                      sim_log_debug(98U, "SRTreeC", "receiveRoutingTask(): NotifyParentMsg enqueued in SendingQueue successfully!!!\n");
              ...
              if (oldparentID != SRTreeC__parentID[sim_node()]) 
                {
                  ...
                  __nesc_hton_uint8(m->depth.nxdata, SRTreeC__curdepth[sim_node()]);
                  __nesc_hton_uint16(m->parentID.nxdata, SRTreeC__parentID[sim_node()]);
                  sim_log_debug(99U, "SRTreeC", "receiveRoutingTask():NotifyParentMsg sending to node= %d... \n", SRTreeC__parentID[sim_node()]);
                  ...
                  if (SRTreeC__NotifySendQueue__enqueue(tmp) == SUCCESS) 
                    {
                      sim_log_debug(100U, "SRTreeC", "receiveRoutingTask(): NotifyParentMsg enqueued in SendingQueue successfully!!! \n");
    ...
    {
      sim_log_debug(101U, "SRTreeC", "receiveRoutingTask():Empty message!!! \n");
...
#line 82
{
  sim_log_debug(169U, "Serial", "Serial: sending a packet of size %d\n", len);
  return FAIL;
}

# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__send(am_id_t arg_0x7ff212d74c70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = SerialActiveMessageC__AMSend__send(arg_0x7ff212d74c70, addr, msg, len);
#line 80
...
#line 91
{
  ...
  sim_log_debug(261U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__current[sim_node()] >= 1) {
      ...
      sim_log_debug(262U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(263U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(264U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
  ...
  if (isEmpty) 
    {
      ...
      sim_log_debug(280U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 175
  ...
  sim_log_debug(281U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
...
static inline void SRTreeC__receiveNotifyTask__runTask(void )
{
  ...
  sim_log_debug(102U, "SRTreeC", "ReceiveNotifyTask(): len=%u \n", len);
  ...
  if (len == sizeof(NotifyParentMsg )) 
    {
      ...
      sim_log_debug(103U, "SRTreeC", "NotifyParentMsg received from %d !!! \n", __nesc_ntoh_uint16(mr->senderID.nxdata));
...
#line 1002
              ...
              sim_log_debug(104U, "Serial", "Sending NotifyParentMsg to PC... \n");
...
#line 1020
          ...
          sim_log_debug(105U, "SRTreeC", "Forwarding NotifyParentMsg from senderID= %d  to parentID=%d \n", __nesc_ntoh_uint16(m->senderID.nxdata), SRTreeC__parentID[sim_node()]);
          ...
          if (SRTreeC__NotifySendQueue__enqueue(tmp) == SUCCESS) 
            {
              sim_log_debug(106U, "SRTreeC", "receiveNotifyTask(): NotifyParentMsg enqueued in SendingQueue successfully!!!\n");
              if (SRTreeC__NotifySendQueue__size() == 1) 
                {
                  SRTreeC__sendNotifyTask__postTask();
                }
    ...
    {
      sim_log_debug(107U, "SRTreeC", "receiveNotifyTask():Empty message!!! \n");
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7ff2134d46e8, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7ff2134d46e8, msg, error);
#line 110
}
#line 110
...
#line 531
  ...
  sim_log_debug(168U, "CpmModelC", "ReadRssi: noise %f\n", noise);
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7ff212d75990, message_t * msg, error_t error){
#line 100
  switch (arg_0x7ff212d75990) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7ff212d75990, msg, error);
#line 100
      break;
#line 100
    }
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__sendDone(uint8_t arg_0x7ff212d75990, message_t * msg, error_t error){
#line 100
  switch (arg_0x7ff212d75990) {
#line 100
    case 0U:
...
#line 100
    default:
#line 100
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__default__sendDone(arg_0x7ff212d75990, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7ff2137e0108){
#line 75
  switch (arg_0x7ff2137e0108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7ff2137e0108);
#line 75
      break;
#line 75
    }
...
{
  LedsP__Led2__clr();
  sim_log_debug(178U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP__Led2__get() ? "off" : "on");
#line 106
  ;
}
...
{
  LedsP__Led1__clr();
  sim_log_debug(175U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP__Led1__get() ? "off" : "on");
#line 91
  ;
}
...
{
  LedsP__Led0__clr();
  sim_log_debug(172U, "LedsC", "LEDS: Led""0"" %s.\n", LedsP__Led0__get() ? "off" : "on");
#line 76
  ;
}
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7ff212d74c70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7ff212d74c70, addr, msg, len);
#line 80
...
#line 269
  ...
  while (list != (void *)0) {
      sim_log_debug(143U, "CpmModelC", "checkReceive: outstanding from %d\n", list->source);
      count++;
  ...
  sim_log_debug(144U, "CpmModelC", "checkReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
...
#line 358
      ...
      sim_log_debug(151U, "CpmModelC,SNRLoss", "-signaling reception\n");
      CpmModelC__Model__receive(mine->msg);
      if (mine->ack) {
          sim_log_debug(152U, "CpmModelC", "yes acknowledgment requested, \n");
        }
      else {
          sim_log_debug(153U, "CpmModelC", "no acknowledgment requested.\n");
        }

      if (mine->ack && CpmModelC__Model__shouldAck(mine->msg)) {
          sim_log_debug(154U, "CpmModelC", " scheduling ack.\n");
          CpmModelC__sim_gain_schedule_ack(mine->source, sim_time() + 1, mine);
        }
      else {
          sim_log_debug(155U, "CpmModelC", " should not ack.\n");
          CpmModelC__free_receive_message(mine);
        }
...
#line 282
  ...
  sim_log_debug(135U, "TossimPacketModelC", "PACKET: Signaling send done at %llu.\n", sim_time());
...
#line 253
{
  ...
  sim_log_debug(133U, "TossimPacketModelC", "PACKET: Broadcasting packet to everyone.\n");
  ...
  sim_log_debug(134U, "TossimPacketModelC", "PACKET: Send done at %llu.\n", evt->time);
...
#line 243
        TossimPacketModelC__sending[sim_node()] = (void *)0;
        sim_log_debug(132U, "TossimPacketModelC", "PACKET: Failed to send packet due to busy channel.\n");
...
#line 194
  ...
  backoff += sim_csma_init_low();
  backoff *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();
  sim_log_debug(131U, "TossimPacketModelC", "Starting CMSA with %lli.\n", backoff);
...
#line 161
{
  if (!TossimPacketModelC__initialized[sim_node()]) {
      sim_log_error(129U, "TossimPacketModelC", "TossimPacketModelC: Send.send() called, but not initialized!\n");
      return EOFF;
    }
  if (!TossimPacketModelC__running[sim_node()]) {
      sim_log_error(130U, "TossimPacketModelC", "TossimPacketModelC: Send.send() called, but not running!\n");
      return EOFF;
    }
...
#line 244
  sim_log_debug(142U, "CpmModelC,SNR", "SNR is %lf, PRR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
...
#line 129
  if (__nesc_ntoh_uint16(header->dest.nxdata) == TossimActiveMessageC__amAddress()) {
      sim_log_debug(122U, "Acks", "Received packet addressed to me so ack it\n");
      return TRUE;
    }
  return FALSE;
}
...
#line 299
      ...
      if (msg != TossimPacketModelC__sending[sim_node()]) {
          ...
          sim_log_debug(136U, "TossimPacketModelC", "Requested ack for 0x%x, but outgoing packet is 0x%x.\n", msg, TossimPacketModelC__sending[sim_node()]);
        }
    }
}
...
#line 162
  sim_log_debug(139U, "CpmModelC,SNRLoss", "SNR is %lf, ARR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
...
#line 55
{
  sim_log_debug(183U, "Pins", "Setting bit %i of port %i.\n", (int )2, (int )27U);
  atm128RegFile[sim_node()][27U] |= 1 << 2;
}
...
#line 55
{
  sim_log_debug(182U, "Pins", "Setting bit %i of port %i.\n", (int )1, (int )27U);
  atm128RegFile[sim_node()][27U] |= 1 << 1;
}
...
#line 55
{
  sim_log_debug(181U, "Pins", "Setting bit %i of port %i.\n", (int )0, (int )27U);
  atm128RegFile[sim_node()][27U] |= 1 << 0;
}
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7ff212e26da0){
#line 83
  switch (arg_0x7ff212e26da0) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7ff212e26da0);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(255U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP__compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP__overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(254U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP__overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(251U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(252U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(244U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(234U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 225
  sim_log_debug(241U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 45
{
  sim_log_debug(108U, "PlatformC", "Initialized mote.\n");
  return SUCCESS;
}
...
#line 86
{
  sim_log_debug(124U, "TossimPacketModelC", "TossimPacketModelC: Init.init() called\n");
...
#line 364
{
  sim_log_debug(246U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 211
  ...
  sim_log_debug(118U, "SimMoteP", "Turning on mote %i at time %s.\n", (int )sim_node(), buf);
...
#line 210
    __nesc_atomic_end(__nesc_atomic); }
  if (result == SUCCESS) {
      sim_log_debug(113U, "Scheduler", "Posting task %hhu.\n", id);
      SimSchedulerBasicP__sim_scheduler_submit_event();
    }
  else {
      sim_log_debug(114U, "Scheduler", "Posting task %hhu, but already posted.\n", id);
    }
  return result;
}
...
#line 75
  ...
  sim_log_debug(109U, "SimMainP", "Mote %li signaling boot at time %s.\n", sim_node(), timeBuf);
  ...
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
    {
      ...
      if (nextTask == SimSchedulerBasicP__NO_TASK) 
        {
          sim_log_debug(111U, "Scheduler", "Told to run next task, but no task to run.\n");
          {
...
#line 193
    __nesc_atomic_end(__nesc_atomic); }
#line 192
  sim_log_debug(112U, "Scheduler", "Running task %hhu.\n", nextTask);
...
static void SRTreeC__SerialAMSend__sendDone(message_t *msg, error_t err)
{
  if (&SRTreeC__serialPkt[sim_node()] == msg) 
    {
      sim_log_debug(72U, "Serial", "Package sent %s \n", err == SUCCESS ? "True" : "False");
...
#line 285
  ...
  sim_log_debug(243U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(249U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
static void SRTreeC__NotifyAMSend__sendDone(message_t *msg, error_t err)
{
  sim_log_debug(70U, "SRTreeC", "A Notify package sent... %s \n", err == SUCCESS ? "True" : "False");
...
static void SRTreeC__RoutingAMSend__sendDone(message_t *msg, error_t err)
{
  sim_log_debug(68U, "SRTreeC", "A Routing package sent... %s \n", err == SUCCESS ? "True" : "False");
...
#line 78
  sim_log_debug(119U, "AM", "AM: Sending packet (id=%hhu, len=%hhu) to %hu\n", id, len, addr);
...
#line 294
  noise = pow(10.0, noise / 10.0);
  while (list != (void *)0) {
      sim_log_debug(145U, "CpmModelC", "packetReceive: outstanding from %d\n", list->source);
      count++;
  ...
  noise = 10.0 * log(noise) / log(10.0);
  sim_log_debug(146U, "CpmModelC", "packetReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
  return noise;
}
...
#line 131
{
  ...
  sim_log_debug(137U, "CpmModelC", "IN: noise_hash_generation()\n");
  ...
  sim_log_debug(138U, "CpmModelC,Tal", "%s: OUT: noise_hash_generation(): %lf\n", sim_time_string(), noise_val);
...
#line 101
      sim_log_debug(229U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) {
              sim_log_debug(230U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(231U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__set[sim_node()]) {
          ...
          sim_log_debug(232U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(250U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(253U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(242U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
...
{
  if (!TossimPacketModelC__initialized[sim_node()]) {
      sim_log_error(125U, "TossimPacketModelC", "TossimPacketModelC: Control.start() called before initialization!\n");
      return FAIL;
    }
  sim_log_debug(126U, "TossimPacketModelC", "TossimPacketModelC: Control.start() called.\n");
...
#line 91
{
  ...
  sim_log_debug(256U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] >= 2) {
      ...
      sim_log_debug(257U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(258U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
          /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] = 2;
      ...
      sim_log_debug(259U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
...
#line 170
  ...
  sim_log_debug(116U, "SimMoteP", "Fetched %s of %i to be %p with len %i (result %i)\n", name, mote, *ptr, *len, result);
  sim_set_node(tmpID);
  return result;
}
...
#line 124
{
  if (!SimMoteP__isOn[sim_node()]) {
      ...
      sim_log_debug(115U, "SimMoteP", "Setting start time to %llu\n", SimMoteP__startTime[sim_node()]);
