...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f5853e73cf8, const void *arg_0x7f5853e72020);
#line 774
...
#line 260
extern double erfc(double arg_0x7f5853df2618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f5853ba9020), 
int (*key_eq_fn)(void *arg_0x7f5853ba9798, void *arg_0x7f5853ba9a38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f58539a5610, int arg_0x7f58539a5878);
static double RandomUniform(void );
...
} __attribute__((packed)) RoutingMsg;
...
} __attribute__((packed)) OneMeasMsg;
...
typedef nx_struct TwoMeasMsg {
  ...
  nx_uint8_t max;
  nx_uint8_t count;
} __attribute__((packed)) TwoMeasMsg;
...
typedef TMilli SRTreeC__NewAggTimer__precision_tag;
typedef TMilli SRTreeC__RoutingMsgTimer__precision_tag;
typedef TMilli SRTreeC__StartMeasureTimer__precision_tag;
typedef TMilli SRTreeC__NewEpochTimer__precision_tag;
...
static void SRTreeC__NewAggTimer__fired(void );
#line 83
static void SRTreeC__RoutingMsgTimer__fired(void );
#line 83
static void SRTreeC__StartMeasureTimer__fired(void );
...
static void SRTreeC__MeasureAMSend__sendDone(
#line 103
message_t * msg, 
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
static void SRTreeC__NewEpochTimer__fired(void );
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
static void SRTreeC__receiveAggregationTask__runTask(void );
#line 75
static void SRTreeC__receiveMeasMsg__runTask(void );
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
static void SRTreeC__sendAggregationTask__runTask(void );
...
SRTreeC__AggregationReceive__receive(
#line 71
message_t * msg, 
void * payload, 
...
SRTreeC__MeasureReceive__receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
static void SRTreeC__sendMeasMsg__runTask(void );
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
static void SRTreeC__AggregationAMSend__sendDone(
#line 103
message_t * msg, 
...
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
static error_t /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
static void /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 9 "PacketQueue.nc"
static error_t /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__PacketQueue__enqueue(message_t newVal);
#line 4
static bool /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__PacketQueue__full(void );



static message_t /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__PacketQueue__dequeue(void );
#line 3
static bool /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__PacketQueue__empty(void );

static uint8_t /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__PacketQueue__size(void );



static error_t /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__PacketQueue__enqueue(message_t newVal);
#line 8
static message_t /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__PacketQueue__dequeue(void );
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
static error_t /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
static void /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 9 "PacketQueue.nc"
static error_t /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__PacketQueue__enqueue(message_t newVal);
#line 4
static bool /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__PacketQueue__full(void );



static message_t /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__PacketQueue__dequeue(void );
#line 3
static bool /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__PacketQueue__empty(void );

static uint8_t /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__PacketQueue__size(void );



static error_t /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__PacketQueue__enqueue(message_t newVal);
#line 8
static message_t /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__PacketQueue__dequeue(void );
#line 3
static bool /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__PacketQueue__empty(void );
# 88 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMPacket.nc"
static am_addr_t SRTreeC__RoutingAMPacket__source(
#line 84
message_t * amsg);
#line 78
static am_addr_t SRTreeC__RoutingAMPacket__destination(
#line 74
message_t * amsg);
#line 103
static void SRTreeC__RoutingAMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
# 73 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
static void SRTreeC__NewAggTimer__startOneShot(uint32_t dt);
#line 73
...
# 114 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
static void SRTreeC__StartMeasureTimer__startPeriodicAt(uint32_t t0, uint32_t dt);
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
static error_t SRTreeC__MeasureAMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
# 114 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
static void SRTreeC__NewEpochTimer__startPeriodicAt(uint32_t t0, uint32_t dt);
# 67 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
static error_t SRTreeC__receiveAggregationTask__postTask(void );
#line 67
static error_t SRTreeC__receiveMeasMsg__postTask(void );
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Packet.nc"
...
uint8_t len);
#line 94
static void SRTreeC__RoutingPacket__setPayloadLength(
#line 90
message_t * msg, 
...
# 9 "PacketQueue.nc"
static error_t SRTreeC__MeasureSendQueue__enqueue(message_t newVal);
#line 5
static uint8_t SRTreeC__MeasureSendQueue__size(void );
#line 4
static bool SRTreeC__MeasureSendQueue__full(void );



static message_t SRTreeC__MeasureSendQueue__dequeue(void );
#line 3
static bool SRTreeC__MeasureSendQueue__empty(void );





static error_t SRTreeC__AggregationSendQueue__enqueue(message_t newVal);
#line 5
static uint8_t SRTreeC__AggregationSendQueue__size(void );
#line 4
static bool SRTreeC__AggregationSendQueue__full(void );



static message_t SRTreeC__AggregationSendQueue__dequeue(void );
#line 3
static bool SRTreeC__AggregationSendQueue__empty(void );
# 67 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
static error_t SRTreeC__sendAggregationTask__postTask(void );
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Packet.nc"
static uint8_t SRTreeC__MeasurePacket__payloadLength(
#line 74
message_t * msg);
#line 126
static 
...
SRTreeC__MeasurePacket__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
#line 94
static void SRTreeC__MeasurePacket__setPayloadLength(
#line 90
message_t * msg, 
...
uint8_t len);
# 67 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
static error_t SRTreeC__sendMeasMsg__postTask(void );
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Packet.nc"
static uint8_t SRTreeC__AggregationPacket__payloadLength(
#line 74
message_t * msg);
#line 126
static 
...
SRTreeC__AggregationPacket__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
#line 94
static void SRTreeC__AggregationPacket__setPayloadLength(
#line 90
message_t * msg, 
...
uint8_t len);
# 9 "PacketQueue.nc"
static error_t SRTreeC__AggregationReceiveQueue__enqueue(message_t newVal);
#line 8
static message_t SRTreeC__AggregationReceiveQueue__dequeue(void );
#line 3
static bool SRTreeC__AggregationReceiveQueue__empty(void );
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
static error_t SRTreeC__AggregationAMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 88 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMPacket.nc"
static am_addr_t SRTreeC__AggregationAMPacket__source(
#line 84
message_t * amsg);
#line 78
static am_addr_t SRTreeC__AggregationAMPacket__destination(
#line 74
message_t * amsg);
#line 103
static void SRTreeC__AggregationAMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 88
static am_addr_t SRTreeC__MeasureAMPacket__source(
#line 84
message_t * amsg);
#line 78
static am_addr_t SRTreeC__MeasureAMPacket__destination(
#line 74
message_t * amsg);
#line 103
static void SRTreeC__MeasureAMPacket__setDestination(
#line 99
message_t * amsg, 
...
# 9 "PacketQueue.nc"
static error_t SRTreeC__MeasureReceiveQueue__enqueue(message_t newVal);
#line 8
static message_t SRTreeC__MeasureReceiveQueue__dequeue(void );
# 92 "SRTreeC.nc"
enum SRTreeC____nesc_unnamed4330 {
#line 92
  SRTreeC__sendMeasMsg = 0U
};
#line 92
typedef int SRTreeC____nesc_sillytask_sendMeasMsg[SRTreeC__sendMeasMsg];
enum SRTreeC____nesc_unnamed4331 {
#line 93
  SRTreeC__receiveMeasMsg = 1U
};
#line 93
typedef int SRTreeC____nesc_sillytask_receiveMeasMsg[SRTreeC__receiveMeasMsg];

enum SRTreeC____nesc_unnamed4332 {
#line 95
  SRTreeC__sendRoutingTask = 2U
};
#line 95
typedef int SRTreeC____nesc_sillytask_sendRoutingTask[SRTreeC__sendRoutingTask];
enum SRTreeC____nesc_unnamed4333 {
#line 96
  SRTreeC__receiveRoutingTask = 3U
};
#line 96
typedef int SRTreeC____nesc_sillytask_receiveRoutingTask[SRTreeC__receiveRoutingTask];

enum SRTreeC____nesc_unnamed4334 {
#line 98
  SRTreeC__sendAggregationTask = 4U
};
#line 98
typedef int SRTreeC____nesc_sillytask_sendAggregationTask[SRTreeC__sendAggregationTask];
enum SRTreeC____nesc_unnamed4335 {
#line 99
  SRTreeC__receiveAggregationTask = 5U
};
#line 99
typedef int SRTreeC____nesc_sillytask_receiveAggregationTask[SRTreeC__receiveAggregationTask];
#line 49
uint16_t SRTreeC__roundCounter[1000];
uint8_t SRTreeC__rand_num[1000];

message_t SRTreeC__radioRoutingSendPkt[1000];
message_t SRTreeC__radioMeasMsgSendPkt[1000];
message_t SRTreeC__radioAggrMsgSendPkt[1000];

bool SRTreeC__RoutingSendBusy[1000];
bool SRTreeC__MeasureSendBusy[1000];
bool SRTreeC__AggregationSendBusy[1000];
bool SRTreeC__MeasureTimerSet[1000];

bool SRTreeC__lostRoutingSendTask[1000];
bool SRTreeC__lostRoutingRecTask[1000];
bool SRTreeC__tina_condition[1000];
bool SRTreeC__max[1000];
bool SRTreeC__count[1000];
bool SRTreeC__max_change[1000];
bool SRTreeC__count_change[1000];
bool SRTreeC__agg_change[1000];
bool SRTreeC__sendAggChange[1000];

uint8_t SRTreeC__curdepth[1000];
uint16_t SRTreeC__parentID[1000];
uint8_t SRTreeC__tct[1000];
uint8_t SRTreeC__agg_function[1000];
uint8_t SRTreeC__min_val[1000];
uint8_t SRTreeC__max_val[1000];
uint8_t SRTreeC__i[1000];
uint16_t SRTreeC__seed[1000];
uint8_t SRTreeC__last_max[1000];
uint8_t SRTreeC__last_count[1000];
uint8_t SRTreeC__last_tina_max[1000];
uint8_t SRTreeC__last_tina_count[1000];
uint8_t SRTreeC__meas_max[1000];

sim_time_t SRTreeC__sim[1000];
uint16_t SRTreeC__p[1000];

FILE *SRTreeC__urandom_file[1000];

nodeInfo SRTreeC__children_values[1000][MAX_CHILDREN];
...
static inline void SRTreeC__setLostRoutingSendTask(bool state);
#line 116
static inline void SRTreeC__setLostRoutingRecTask(bool state);





static void SRTreeC__setRoutingSendBusy(bool state);
#line 137
...
#line 262
static inline void SRTreeC__NewEpochTimer__fired(void );
#line 307
...
#line 479
static inline void SRTreeC__sendMeasMsg__runTask(void );
#line 522
static inline void SRTreeC__receiveMeasMsg__runTask(void );
#line 597
static inline void SRTreeC__MeasureAMSend__sendDone(message_t *msg, error_t err);
...
static inline message_t *SRTreeC__MeasureReceive__receive(message_t *msg, void *payload, uint8_t len);
#line 646
static inline void SRTreeC__StartMeasureTimer__fired(void );
#line 906
static inline void SRTreeC__sendAggregationTask__runTask(void );
#line 949
static inline void SRTreeC__receiveAggregationTask__runTask(void );
#line 992
static inline void SRTreeC__AggregationAMSend__sendDone(message_t *msg, error_t err);
...
static inline message_t *SRTreeC__AggregationReceive__receive(message_t *msg, void *payload, uint8_t len);
#line 1033
static inline void SRTreeC__NewAggTimer__fired(void );
...
enum SimSchedulerBasicP____nesc_unnamed4336 {

  SimSchedulerBasicP__NUM_TASKS = 14U, 
...
#line 96
  TossimPacketModelC__startDoneTask = 6U
};
#line 96
...
enum TossimPacketModelC____nesc_unnamed4338 {
#line 101
  TossimPacketModelC__stopDoneTask = 7U
};
#line 101
...
#line 145
  TossimPacketModelC__sendDoneTask = 8U
};
#line 145
...
enum CpmModelC____nesc_unnamed4340 {
#line 528
  CpmModelC__read_rssi_task = 9U
};
#line 528
...
enum /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0____nesc_unnamed4341 {
...
static inline error_t /*SRTreeAppC.RoutingSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
static void /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
static error_t /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMPacket.nc"
static void /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/home/tinyos/local/src/tinyos-2x/tos/system/AMQueueEntryP.nc"
static inline error_t /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
# 12 "PacketQueueC.nc"
message_t /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__Q[1000][5];
uint8_t /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__headIndex[1000];
uint8_t /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__tailIndex[1000];
uint8_t /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__size[1000];
...
static bool /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__PacketQueue__empty(void );
#line 35
static inline bool /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__PacketQueue__full(void );
#line 54
static uint8_t /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__PacketQueue__size(void );
#line 89
static error_t /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__PacketQueue__enqueue(message_t newPkt);
#line 137
static inline message_t /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__PacketQueue__dequeue(void );
#line 12
message_t /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__Q[1000][3];
uint8_t /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__headIndex[1000];
uint8_t /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__tailIndex[1000];
uint8_t /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__size[1000];
#line 89
static inline error_t /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__PacketQueue__enqueue(message_t newPkt);
#line 137
static inline message_t /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__PacketQueue__dequeue(void );
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
static void /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
static error_t /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMPacket.nc"
static void /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/home/tinyos/local/src/tinyos-2x/tos/system/AMQueueEntryP.nc"
static inline error_t /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__sendDone(message_t *m, error_t err);
# 12 "PacketQueueC.nc"
message_t /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__Q[1000][5];
uint8_t /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__headIndex[1000];
uint8_t /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__tailIndex[1000];
uint8_t /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__size[1000];
...
static bool /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__PacketQueue__empty(void );
#line 35
static inline bool /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__PacketQueue__full(void );
#line 54
static inline uint8_t /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__PacketQueue__size(void );
#line 89
static inline error_t /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__PacketQueue__enqueue(message_t newPkt);
#line 137
static message_t /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__PacketQueue__dequeue(void );
#line 12
message_t /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__Q[1000][3];
uint8_t /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__headIndex[1000];
uint8_t /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__tailIndex[1000];
uint8_t /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__size[1000];
...
static inline bool /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__PacketQueue__empty(void );
#line 89
static inline error_t /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__PacketQueue__enqueue(message_t newPkt);
#line 137
static message_t /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__PacketQueue__dequeue(void );
...
#line 238
  sim_log_debug(168U, "Packet", "Delivering packet to %i at %s\n", (int )sim_node(), sim_time_string());
  ...
  if (isFull) 
    {
      ...
      sim_log_debug(250U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
...
static inline message_t *SRTreeC__RoutingReceive__receive(message_t *msg, void *payload, uint8_t len)
{
  ...
  sim_log_debug(73U, "SRTreeC", "### RoutingReceive.receive() start ##### \n");
  sim_log_debug(74U, "SRTreeC", "Something received!!! from %u\n", msource);
...
#line 344
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(75U, "SRTreeC", "RoutingMsg enqueue failed!!! \n");
    }

  sim_log_debug(76U, "SRTreeC", "### RoutingReceive.receive() end ##### \n");
  return msg;
}

# 67 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static error_t SRTreeC__receiveMeasMsg__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP__TaskBasic__postTask(SRTreeC__receiveMeasMsg);
#line 67
...
#line 93
    {
      ...
      wasEmpty = /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__size[sim_node()] == 0;

      isFull = /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__size[sim_node()] == 3;
    }
#line 98
    __nesc_atomic_end(__nesc_atomic); }
  ...
  if (isFull) 
    {
      ...
      sim_log_debug(258U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
      ...
      if (!wasEmpty) 
        {
          ...
          /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__tailIndex[sim_node()] = (/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__tailIndex[sim_node()] + 1) % 3;
        }


      memcpy(&/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__Q[sim_node()][/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__tailIndex[sim_node()]], &newPkt, sizeof(message_t ));

      /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__size[sim_node()]++;
    }
#line 124
    __nesc_atomic_end(__nesc_atomic); }

  sim_log_debug(259U, "PacketQueueC", "enqueue(): Enqueued in pos= %u \n", /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__tailIndex[sim_node()]);
...
# 9 "PacketQueue.nc"
inline static error_t SRTreeC__MeasureReceiveQueue__enqueue(message_t newVal){
#line 9
  unsigned char __nesc_result;
#line 9

#line 9
  __nesc_result = /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__PacketQueue__enqueue(newVal);
#line 9
...
#line 9
# 88 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMPacket.nc"
inline static am_addr_t SRTreeC__MeasureAMPacket__source(message_t * amsg){
#line 88
  unsigned short __nesc_result;
#line 88
...
static inline message_t *SRTreeC__MeasureReceive__receive(message_t *msg, void *payload, uint8_t len)
{
  ...
  msource = SRTreeC__MeasureAMPacket__source(msg);

  sim_log_debug(95U, "MeasureMsg", "### MeasureReceive.receive() start ##### \n");
  if (len == sizeof(OneMeasMsg )) {
    sim_log_debug(96U, "MeasureMsg", "Something received!!! from %u\n", msource);
    }
  else {
#line 617
    sim_log_debug(97U, "MeasureMsg", "Something received!!! from %u\n", msource);
    }
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 619
    {
...
#line 621
    __nesc_atomic_end(__nesc_atomic); }
  enqueueDone = SRTreeC__MeasureReceiveQueue__enqueue(tmp);

  if (enqueueDone == SUCCESS) 
    {
      SRTreeC__receiveMeasMsg__postTask();
    }
  else 
    {
      sim_log_debug(98U, "MeasureMsg", "MeasureMsg enqueue failed!!! \n");
    }

  sim_log_debug(99U, "MeasureMsg", "### MeasureReceive.receive() end ##### \n");
  if (SRTreeC__MeasureTimerSet[sim_node()]) 
    {
      if (len == sizeof(OneMeasMsg )) {
        sim_log_debug(100U, "Tina", "| Node %d received from %d\n", TOS_NODE_ID, msource);
        }
      else {
#line 639
        sim_log_debug(101U, "Tina", "| Node %d received from %d\n", TOS_NODE_ID, msource);
        }
    }
#line 641
  return msg;
...
# 67 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static error_t SRTreeC__receiveAggregationTask__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP__TaskBasic__postTask(SRTreeC__receiveAggregationTask);
#line 67
...
#line 93
    {
      ...
      wasEmpty = /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__size[sim_node()] == 0;

      isFull = /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__size[sim_node()] == 3;
    }
#line 98
    __nesc_atomic_end(__nesc_atomic); }
      ...
      if (!wasEmpty) 
        {
          ...
          /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__tailIndex[sim_node()] = (/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__tailIndex[sim_node()] + 1) % 3;
        }


      memcpy(&/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__Q[sim_node()][/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__tailIndex[sim_node()]], &newPkt, sizeof(message_t ));

      /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__size[sim_node()]++;
    }
#line 124
    __nesc_atomic_end(__nesc_atomic); }

  sim_log_debug(267U, "PacketQueueC", "enqueue(): Enqueued in pos= %u \n", /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__tailIndex[sim_node()]);
...
# 9 "PacketQueue.nc"
inline static error_t SRTreeC__AggregationReceiveQueue__enqueue(message_t newVal){
#line 9
  unsigned char __nesc_result;
#line 9

#line 9
  __nesc_result = /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__PacketQueue__enqueue(newVal);
#line 9
...
#line 9
# 88 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMPacket.nc"
inline static am_addr_t SRTreeC__AggregationAMPacket__source(message_t * amsg){
#line 88
  unsigned short __nesc_result;
#line 88
...
static inline message_t *SRTreeC__AggregationReceive__receive(message_t *msg, void *payload, uint8_t len)
{
  ...
  msource = SRTreeC__AggregationAMPacket__source(msg);

  sim_log_debug(140U, "ChangeAggr", "### AggregationReceive.receive() start ##### \n");
  if (len == sizeof(AggMessage )) {
    sim_log_debug(141U, "ChangeAggr", "Something received!!! from %u\n", msource);
    }
  else {
#line 1012
    sim_log_debug(142U, "ChangeAggr", "Something received!!! from %u\n", msource);
    }
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 1014
    {
...
#line 1016
    __nesc_atomic_end(__nesc_atomic); }
  enqueueDone = SRTreeC__AggregationReceiveQueue__enqueue(tmp);

  if (enqueueDone == SUCCESS) 
    {
      SRTreeC__receiveAggregationTask__postTask();
    }
  else 
    {
      sim_log_debug(143U, "ChangeAggr", "AggMsg enqueue failed!!! \n");
    }

  sim_log_debug(144U, "ChangeAggr", "### AggregationReceive.receive() end ##### \n");
  return msg;
}
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f5853502908, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f5853502908) {
#line 78
    case 1:
#line 78
...
#line 78
    case 2:
#line 78
      __nesc_result = SRTreeC__MeasureReceive__receive(msg, payload, len);
#line 78
      break;
#line 78
    case 3:
#line 78
      __nesc_result = SRTreeC__AggregationReceive__receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f5853502908, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f5853500480, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f5853500480, msg, payload, len);
#line 78
...
static inline void SimSchedulerBasicP__Scheduler__init(void )
{
  sim_log_debug(155U, "Scheduler", "Initializing scheduler.\n");
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static error_t /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
#line 103
inline static void /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 2);
  return /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}

# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t SRTreeC__MeasureAMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 80
...
#line 80
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMPacket.nc"
inline static am_addr_t SRTreeC__MeasureAMPacket__destination(message_t * amsg){
#line 78
  unsigned short __nesc_result;
#line 78
...
#line 143
    {
      isEmpty = /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__size[sim_node()] == 0;
    }
#line 145
    __nesc_atomic_end(__nesc_atomic); }
  ...
  if (isEmpty) 
    {
      ...
      sim_log_debug(256U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 155
        {
          m = /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__Q[sim_node()][/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__headIndex[sim_node()]];
        }
#line 157
        __nesc_atomic_end(__nesc_atomic); }
      return m;
...
#line 162
    {
      tmp = /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__headIndex[sim_node()];

      if (/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__tailIndex[sim_node()] != /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__headIndex[sim_node()]) 
        {


          /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__headIndex[sim_node()] = (/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__headIndex[sim_node()] + 1) % 5;
        }

      /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__size[sim_node()]--;

      m = /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__Q[sim_node()][tmp];
    }
#line 175
    __nesc_atomic_end(__nesc_atomic); }

  sim_log_debug(257U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
...
# 8 "PacketQueue.nc"
inline static message_t SRTreeC__MeasureSendQueue__dequeue(void ){
#line 8
  nx_struct message_t __nesc_result;
#line 8

#line 8
  __nesc_result = /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__PacketQueue__dequeue();
#line 8
...
#line 8
#line 3
inline static bool SRTreeC__MeasureSendQueue__empty(void ){
#line 3
  unsigned char __nesc_result;
#line 3

#line 3
  __nesc_result = /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__PacketQueue__empty();
#line 3
...
static inline void SRTreeC__sendMeasMsg__runTask(void )
{
  ...
  if (SRTreeC__MeasureSendQueue__empty()) 
    {
      sim_log_debug(88U, "MeasureMsg", "sendMeasMsg(): Q is empty!\n");
      return;
    }


  if (SRTreeC__MeasureSendBusy[sim_node()]) 
    {
      sim_log_debug(89U, "MeasureMsg", "sendMeasMsg(): MeasureSendBusy= TRUE!!!\n");
      return;
    }

  SRTreeC__radioMeasMsgSendPkt[sim_node()] = SRTreeC__MeasureSendQueue__dequeue();

  mlen = SRTreeC__MeasurePacket__payloadLength(&SRTreeC__radioMeasMsgSendPkt[sim_node()]);
  mdest = SRTreeC__MeasureAMPacket__destination(&SRTreeC__radioMeasMsgSendPkt[sim_node()]);

  if (mlen != sizeof(OneMeasMsg ) && mlen != sizeof(TwoMeasMsg )) 
    {
      sim_log_debug(90U, "MeasureMsg", "\t\\sendMeasMsg(): Unknown message!!!\n");
      return;
    }
  sendDone = SRTreeC__MeasureAMSend__send(mdest, &SRTreeC__radioMeasMsgSendPkt[sim_node()], mlen);

  if (sendDone == SUCCESS) 
    {
      sim_log_debug(91U, "MeasureMsg", "sendMeasMsg(): Send returned success!!!\n");
    }
  else 
    {
      sim_log_debug(92U, "MeasureMsg", "send failed!!!\n");
    }
}
...
inline static void * SRTreeC__MeasurePacket__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 143
    {
      isEmpty = /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__size[sim_node()] == 0;
    }
#line 145
    __nesc_atomic_end(__nesc_atomic); }
  ...
  if (isEmpty) 
    {
      ...
      sim_log_debug(260U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 155
        {
          m = /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__Q[sim_node()][/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__headIndex[sim_node()]];
        }
#line 157
        __nesc_atomic_end(__nesc_atomic); }
      return m;
...
#line 162
    {
      tmp = /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__headIndex[sim_node()];

      if (/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__tailIndex[sim_node()] != /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__headIndex[sim_node()]) 
        {


          /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__headIndex[sim_node()] = (/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__headIndex[sim_node()] + 1) % 3;
        }

      /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__size[sim_node()]--;

      m = /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__Q[sim_node()][tmp];
    }
#line 175
    __nesc_atomic_end(__nesc_atomic); }

  sim_log_debug(261U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
...
# 8 "PacketQueue.nc"
inline static message_t SRTreeC__MeasureReceiveQueue__dequeue(void ){
#line 8
  nx_struct message_t __nesc_result;
#line 8

#line 8
  __nesc_result = /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__PacketQueue__dequeue();
#line 8
...
static inline void SRTreeC__receiveMeasMsg__runTask(void )
{
  ...
  radioMeasMsgRecPkt = SRTreeC__MeasureReceiveQueue__dequeue();

  len = SRTreeC__MeasurePacket__payloadLength(&radioMeasMsgRecPkt);

  sim_log_debug(93U, "MeasureMsg", "receiveMeasMsg(): len=%u \n", len);
  ...
  if (len == sizeof(OneMeasMsg )) 
    {
      OneMeasMsg *mpkt = (OneMeasMsg *)SRTreeC__MeasurePacket__getPayload(&radioMeasMsgRecPkt, len);

      uint16_t senderID = SRTreeC__MeasureAMPacket__source(&radioMeasMsgRecPkt);

      for (SRTreeC__i[sim_node()] = 0; SRTreeC__i[sim_node()] < MAX_CHILDREN; SRTreeC__i[sim_node()]++) 
        {

          if (__nesc_ntoh_uint16(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].nodeID.nxdata) == senderID || __nesc_ntoh_uint16(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].nodeID.nxdata) == 0) 
            {
              __nesc_hton_uint16(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].nodeID.nxdata, senderID);

              if (SRTreeC__agg_function[sim_node()] == 0) {
                __nesc_hton_uint8(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].max.nxdata, __nesc_ntoh_uint8(mpkt->measurement.nxdata));
                }
#line 554
              if (SRTreeC__agg_function[sim_node()] == 1) 
                {
                  __nesc_hton_uint8(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].count.nxdata, __nesc_ntoh_uint8(mpkt->measurement.nxdata) & 0x7f);
                }
              if (SRTreeC__agg_function[sim_node()] == 2) 
                {

                  if ((__nesc_ntoh_uint8(mpkt->measurement.nxdata) >> 8) == 1) {
                    __nesc_hton_uint8(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].count.nxdata, __nesc_ntoh_uint8(mpkt->measurement.nxdata) & 0x7f);
                    }
                  else {
#line 564
...
#line 571
    if (len == sizeof(TwoMeasMsg )) 
      {
        TwoMeasMsg *mpkt = (TwoMeasMsg *)SRTreeC__MeasurePacket__getPayload(&radioMeasMsgRecPkt, len);
        uint16_t senderID = SRTreeC__MeasureAMPacket__source(&radioMeasMsgRecPkt);
            ...
            if (__nesc_ntoh_uint16(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].nodeID.nxdata) == senderID || __nesc_ntoh_uint16(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].nodeID.nxdata) == 0) 
              {
                ...
                __nesc_hton_uint8(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].max.nxdata, __nesc_ntoh_uint8(mpkt->max.nxdata));
                __nesc_hton_uint8(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].count.nxdata, __nesc_ntoh_uint8(mpkt->count.nxdata));
      ...
      {
        sim_log_debug(94U, "MeasureMsg", "receiveMeasMsg():Empty message!!! \n");
        return;
      }
    }
}
...
#line 55
{
  ...
  /*SRTreeAppC.RoutingSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(msg, 1);
...
#line 80
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMPacket.nc"
inline static am_addr_t SRTreeC__RoutingAMPacket__destination(message_t * amsg){
#line 78
  unsigned short __nesc_result;
#line 78
  ...
  if (isEmpty) 
    {
      ...
      sim_log_debug(248U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 175
  ...
  sim_log_debug(249U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
...
#line 103
    {
      SRTreeC__lostRoutingSendTask[sim_node()] = state;
    }
#line 105
    __nesc_atomic_end(__nesc_atomic); }
  if (state == TRUE) 
...
static inline void SRTreeC__sendRoutingTask__runTask(void )
{
  ...
  if (SRTreeC__RoutingSendQueue__empty()) 
    {
      sim_log_debug(77U, "SRTreeC", "sendRoutingTask(): Q is empty!\n");
      return;
    }
  ...
  if (SRTreeC__RoutingSendBusy[sim_node()]) 
    {
      sim_log_debug(78U, "SRTreeC", "sendRoutingTask(): RoutingSendBusy= TRUE!!!\n");
      SRTreeC__setLostRoutingSendTask(TRUE);
      return;
    }

  SRTreeC__radioRoutingSendPkt[sim_node()] = SRTreeC__RoutingSendQueue__dequeue();

  mlen = SRTreeC__RoutingPacket__payloadLength(&SRTreeC__radioRoutingSendPkt[sim_node()]);
  mdest = SRTreeC__RoutingAMPacket__destination(&SRTreeC__radioRoutingSendPkt[sim_node()]);
  if (mlen != sizeof(RoutingMsg )) 
    {
      sim_log_debug(79U, "SRTreeC", "\t\tsendRoutingTask(): Unknown message!!!\n");
      return;
    }
  sendDone = SRTreeC__RoutingAMSend__send(mdest, &SRTreeC__radioRoutingSendPkt[sim_node()], mlen);

  if (sendDone == SUCCESS) 
    {
      sim_log_debug(80U, "SRTreeC", "sendRoutingTask(): Send returned success!!!\n");
      SRTreeC__setRoutingSendBusy(TRUE);
    }
  else 
    {
      sim_log_debug(81U, "SRTreeC", "send failed!!!\n");
    }
}
...
# 114 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void SRTreeC__StartMeasureTimer__startPeriodicAt(uint32_t t0, uint32_t dt){
#line 114
...
#line 118
    {
      SRTreeC__lostRoutingRecTask[sim_node()] = state;
    }
#line 120
    __nesc_atomic_end(__nesc_atomic); }
}
  ...
  if (isEmpty) 
    {
      ...
      sim_log_debug(252U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 175
  ...
  sim_log_debug(253U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
...
static inline void SRTreeC__receiveRoutingTask__runTask(void )
{
  ...
  sim_log_debug(82U, "SRTreeC", "ReceiveRoutingTask(): len=%u \n", len);
  ...
  if (len == sizeof(RoutingMsg )) 
    {
      RoutingMsg *mpkt = (RoutingMsg *)SRTreeC__RoutingPacket__getPayload(&radioRoutingRecPkt, len);
      uint16_t msource = SRTreeC__RoutingAMPacket__source(&radioRoutingRecPkt);

      sim_log_debug(83U, "SRTreeC", "receiveRoutingTask():senderID= %d , depth= %d \n", msource, __nesc_ntoh_uint8(mpkt->depth.nxdata));

      SRTreeC__tct[sim_node()] = __nesc_ntoh_uint8(mpkt->parameters.nxdata) >> 4;
      SRTreeC__agg_function[sim_node()] = __nesc_ntoh_uint8(mpkt->parameters.nxdata) & 0x0f;
      sim_log_debug(84U, "TCT", "TCT is %u\n", SRTreeC__tct[sim_node()]);
      sim_log_debug(85U, "aggregation_function", "Aggregation is %u\n", SRTreeC__agg_function[sim_node()]);
    ...
    {
      sim_log_debug(86U, "SRTreeC", "receiveRoutingTask():Empty message!!! \n");
      SRTreeC__setLostRoutingRecTask(TRUE);
      return;
    }
  SRTreeC__rand_num[sim_node()] = rand() % (TIMER_VERY_FAST_PERIOD - 20);
  sim_log_debug(87U, "Random", "Node: %d, Random: %d \n", TOS_NODE_ID, SRTreeC__rand_num[sim_node()]);

  SRTreeC__sim[sim_node()] = sim_time() / 10000000;
  SRTreeC__StartMeasureTimer__startPeriodicAt(-SRTreeC__sim[sim_node()] - ((SRTreeC__curdepth[sim_node()] + 1) * TIMER_VERY_FAST_PERIOD + SRTreeC__rand_num[sim_node()]), TIMER_PERIOD_MILLI);
}

# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static error_t /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 162 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMPacket.nc"
inline static void /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC__AMPacket__setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC__AMPacket__setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setDestination(msg, dest);
  /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setType(msg, 3);
  return /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__send(msg, len);
}

# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t SRTreeC__AggregationAMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__send(addr, msg, len);
#line 80
...
#line 80
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMPacket.nc"
inline static am_addr_t SRTreeC__AggregationAMPacket__destination(message_t * amsg){
#line 78
  unsigned short __nesc_result;
#line 78
...
#line 78
# 8 "PacketQueue.nc"
inline static message_t SRTreeC__AggregationSendQueue__dequeue(void ){
#line 8
  nx_struct message_t __nesc_result;
#line 8

#line 8
  __nesc_result = /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__PacketQueue__dequeue();
#line 8
...
#line 8
#line 3
inline static bool SRTreeC__AggregationSendQueue__empty(void ){
#line 3
  unsigned char __nesc_result;
#line 3

#line 3
  __nesc_result = /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__PacketQueue__empty();
#line 3
...
static inline void SRTreeC__sendAggregationTask__runTask(void )
{
  ...
  if (SRTreeC__AggregationSendQueue__empty()) 
    {
      sim_log_debug(130U, "ChangeAggr", "sendAggregationTask(): Q is empty!\n");
      return;
    }


  if (SRTreeC__AggregationSendBusy[sim_node()]) 
    {
      sim_log_debug(131U, "ChangeAggr", "sendAggregationTask(): AggregationSendBusy= TRUE!!!\n");
      return;
    }

  SRTreeC__radioAggrMsgSendPkt[sim_node()] = SRTreeC__AggregationSendQueue__dequeue();

  mlen = SRTreeC__AggregationPacket__payloadLength(&SRTreeC__radioAggrMsgSendPkt[sim_node()]);
  mdest = SRTreeC__AggregationAMPacket__destination(&SRTreeC__radioAggrMsgSendPkt[sim_node()]);

  if (mlen != sizeof(AggMessage )) 
    {
      sim_log_debug(132U, "ChangeAggr", "\t\\sendAggregationTask(): Unknown message!!!\n");
      return;
    }
  sendDone = SRTreeC__AggregationAMSend__send(mdest, &SRTreeC__radioAggrMsgSendPkt[sim_node()], mlen);

  if (sendDone == SUCCESS) 
    {
      sim_log_debug(133U, "ChangeAggr", "sendAggregationTask(): Send returned success!!!\n");
    }
  else 
    {
      sim_log_debug(134U, "ChangeAggr", "send failed!!!\n");
    }
}

# 73 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void SRTreeC__NewAggTimer__startOneShot(uint32_t dt){
#line 73
...
#line 73
# 126 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Packet.nc"
inline static void * SRTreeC__AggregationPacket__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
# 8 "PacketQueue.nc"
inline static message_t SRTreeC__AggregationReceiveQueue__dequeue(void ){
#line 8
  nx_struct message_t __nesc_result;
#line 8

#line 8
  __nesc_result = /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__PacketQueue__dequeue();
#line 8
...
static inline void SRTreeC__receiveAggregationTask__runTask(void )
{
  ...
  if (!SRTreeC__sendAggChange[sim_node()]) 
    {

      radioAggrMsgRecPkt = SRTreeC__AggregationReceiveQueue__dequeue();

      len = SRTreeC__AggregationPacket__payloadLength(&radioAggrMsgRecPkt);

      sim_log_debug(135U, "ChangeAggr", "receiveAggregationTask(): len=%u \n", len);
      ...
      if (len == sizeof(AggMessage )) 
        {
          AggMessage *ampkt = (AggMessage *)SRTreeC__AggregationPacket__getPayload(&radioAggrMsgRecPkt, len);

          SRTreeC__agg_function[sim_node()] = __nesc_ntoh_uint8(ampkt->agg_msg.nxdata);
          SRTreeC__sendAggChange[sim_node()] = TRUE;
          sim_log_debug(136U, "ChangeAggrResult", "&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&\n");
          sim_log_debug(137U, "ChangeAggrResult", "Node: %d Depth: %d New Aggregation is : %d\n", TOS_NODE_ID, SRTreeC__curdepth[sim_node()], SRTreeC__agg_function[sim_node()]);
          sim_log_debug(138U, "ChangeAggrResult", "&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&\n");

          if (TOS_NODE_ID != 0) 
            {
              SRTreeC__NewAggTimer__startOneShot(TIMER_FAST_PERIOD);
            }
        }
      else 
        {
          sim_log_debug(139U, "ChangeAggr", "receiveAggregationTask():Empty message!!! \n");
          return;
        }
    }
}
...
static inline void SRTreeC__RadioControl__startDone(error_t err)
{
  if (err == SUCCESS) 
    {
      sim_log_debug(48U, "Radio", "Radio initialized successfully!!!\n");
    ...
    {
      sim_log_debug(49U, "Radio", "Radio initialization failed! Retrying...\n");
...
static inline void SRTreeC__RadioControl__stopDone(error_t err)
{
  sim_log_debug(50U, "Radio", "Radio stopped!\n");
}
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f58535036e8, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f58535036e8, msg, error);
#line 110
}
#line 110
...
#line 531
  ...
  sim_log_debug(213U, "CpmModelC", "ReadRssi: noise %f\n", noise);
...
# 67 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static error_t SRTreeC__sendMeasMsg__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP__TaskBasic__postTask(SRTreeC__sendMeasMsg);
#line 67
...
static inline void SRTreeC__MeasureAMSend__sendDone(message_t *msg, error_t err)
{
  if (!SRTreeC__MeasureSendQueue__empty()) 
    {
      SRTreeC__sendMeasMsg__postTask();
    }
}

# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  SRTreeC__MeasureAMSend__sendDone(msg, error);
#line 110
}
#line 110
# 65 "/home/tinyos/local/src/tinyos-2x/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}

# 67 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static error_t SRTreeC__sendAggregationTask__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP__TaskBasic__postTask(SRTreeC__sendAggregationTask);
#line 67
...
static inline void SRTreeC__AggregationAMSend__sendDone(message_t *msg, error_t err)
{
  if (!SRTreeC__AggregationSendQueue__empty()) 
    {
      SRTreeC__sendAggregationTask__postTask();
    }
}

# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  SRTreeC__AggregationAMSend__sendDone(msg, error);
#line 110
}
#line 110
# 65 "/home/tinyos/local/src/tinyos-2x/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__sendDone(m, err);
}
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f5852fa4e18, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f5852fa4e18) {
#line 100
    case 0U:
#line 100
...
#line 100
    case 1U:
#line 100
      /*SRTreeAppC.MeasureSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    case 2U:
#line 100
      /*SRTreeAppC.AggregationSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f5852fa4e18, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f585387f108){
#line 75
  switch (arg_0x7f585387f108) {
#line 75
    case SRTreeC__sendMeasMsg:
#line 75
      SRTreeC__sendMeasMsg__runTask();
#line 75
      break;
#line 75
    case SRTreeC__receiveMeasMsg:
#line 75
      SRTreeC__receiveMeasMsg__runTask();
#line 75
      break;
#line 75
...
#line 75
      break;
#line 75
    case SRTreeC__sendAggregationTask:
#line 75
      SRTreeC__sendAggregationTask__runTask();
#line 75
      break;
#line 75
    case SRTreeC__receiveAggregationTask:
#line 75
      SRTreeC__receiveAggregationTask__runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f585387f108);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f5852fa1020, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f5852fa1020, addr, msg, len);
#line 80
...
#line 269
  ...
  while (list != (void *)0) {
      sim_log_debug(188U, "CpmModelC", "checkReceive: outstanding from %d\n", list->source);
      count++;
  ...
  sim_log_debug(189U, "CpmModelC", "checkReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
...
#line 321
{
  ...
  sim_log_debug(192U, "CpmModelC", "Handling reception event @ %s.\n", sim_time_string());
  while (list != (void *)0) {
      if (list->next == mine) {
          predecessor = list;
        }
...
#line 336
    if (mine == CpmModelC__outstandingReceptionHead[sim_node()]) {
        ...
        sim_log_error(193U, "CpmModelC", "Incoming packet list structure is corrupted: entry is not the head and no entry points to it.\n");
      }
    }
#line 342
  sim_log_debug(194U, "CpmModelC,SNRLoss", "Packet from %i to %i\n", (int )mine->source, (int )sim_node());
  if (!CpmModelC__checkReceive(mine)) {
      sim_log_debug(195U, "CpmModelC,SNRLoss", " - lost packet from %i as SNR was too low.\n", (int )mine->source);
      mine->lost = 1;
    }
...
#line 358
      ...
      sim_log_debug(196U, "CpmModelC,SNRLoss", "-signaling reception\n");
      CpmModelC__Model__receive(mine->msg);
      if (mine->ack) {
          sim_log_debug(197U, "CpmModelC", "yes acknowledgment requested, \n");
        }
      else {
          sim_log_debug(198U, "CpmModelC", "no acknowledgment requested.\n");
        }

      if (mine->ack && CpmModelC__Model__shouldAck(mine->msg)) {
          sim_log_debug(199U, "CpmModelC", " scheduling ack.\n");
          CpmModelC__sim_gain_schedule_ack(mine->source, sim_time() + 1, mine);
        }
      else {
          sim_log_debug(200U, "CpmModelC", " should not ack.\n");
          CpmModelC__free_receive_message(mine);
        }
      ...
      if (RandomUniform() < 0.001) {
          sim_log_debug(201U, "CpmModelC,SNRLoss", "Packet was technically lost, but TOSSIM introduces an ack false positive rate.\n");
          if (mine->ack && CpmModelC__Model__shouldAck(mine->msg)) {
              sim_log_debug_clear(202U, "CpmModelC", " scheduling ack.\n");
              CpmModelC__sim_gain_schedule_ack(mine->source, sim_time() + 1, mine);
            }
          else {
              CpmModelC__free_receive_message(mine);
      ...
      CpmModelC__receiving[sim_node()] = 0;
      sim_log_debug_clear(203U, "CpmModelC,SNRLoss", "  -packet was lost.\n");
    }
}
...
#line 407
  ...
  if (!sim_mote_is_on(sim_node())) {
      sim_log_debug(204U, "CpmModelC", "Lost packet from %i due to %i being off\n", source, sim_node());
      rcv->lost = 1;
    }
  else {
#line 430
    if (!CpmModelC__shouldReceive(power - noiseStr)) {
        sim_log_debug(205U, "CpmModelC,SNRLoss", "Lost packet from %i to %i due to SNR being too low (%i)\n", source, sim_node(), (int )(power - noiseStr));
        rcv->lost = 1;
      }
    else {
#line 434
...
#line 437
        if (CpmModelC__receiving[sim_node()]) {
            sim_log_debug(206U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-reception\n", source, sim_node());
            rcv->lost = 1;
          }
        else {
#line 441
          if (CpmModelC__transmitting[sim_node()] && rcv->start < CpmModelC__transmissionEndTime[sim_node()] && CpmModelC__transmissionEndTime[sim_node()] <= rcv->end) {
              sim_log_debug(207U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-transmission, transmissionEndTime %llu\n", source, sim_node(), CpmModelC__transmissionEndTime[sim_node()]);
              rcv->lost = 1;
            }
          else {
...
#line 449
  ...
  while (list != (void *)0) {
      ...
      if (!CpmModelC__shouldReceive(list->power - rcv->power)) {
          sim_log_debug(208U, "Gain,SNRLoss", "Going to lose packet from %i with signal %lf as am receiving a packet from %i with signal %lf\n", list->source, list->power, source, rcv->power);
          list->lost = 1;
        }
      list = list->next;
    }
...
#line 471
  sim_log_debug(209U, "CpmModelC", "Enqueing reception event for %i at %llu with power %lf.\n", dest, endTime, power);
  sim_set_node(dest);
...
#line 480
  ...
  sim_log_debug(210U, "CpmModelC", "Node %i transmitting to %i, finishes at %llu.\n", sim_node(), dest, endTime);
...
#line 487
  ...
  while (list != (void *)0) {
      list->lost = 1;
      sim_log_debug(211U, "CpmModelC,SNRLoss", "Lost packet from %i because %i has outstanding reception, startTime %llu endTime %llu\n", list->source, sim_node(), list->start, list->end);
      list = list->next;
    }
}
...
#line 282
  ...
  sim_log_debug(180U, "TossimPacketModelC", "PACKET: Signaling send done at %llu.\n", sim_time());
...
#line 253
{
  ...
  sim_log_debug(178U, "TossimPacketModelC", "PACKET: Broadcasting packet to everyone.\n");
  ...
  sim_log_debug(179U, "TossimPacketModelC", "PACKET: Send done at %llu.\n", evt->time);
...
#line 500
{
  ...
  sim_log_debug(212U, "CpmModelC", "setPendingTransmission: transmitting %i @ %s\n", CpmModelC__transmitting[sim_node()], sim_time_string());
}
...
#line 243
        TossimPacketModelC__sending[sim_node()] = (void *)0;
        sim_log_debug(177U, "TossimPacketModelC", "PACKET: Failed to send packet due to busy channel.\n");
...
#line 194
  ...
  backoff += sim_csma_init_low();
  backoff *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();
  sim_log_debug(176U, "TossimPacketModelC", "Starting CMSA with %lli.\n", backoff);
...
#line 161
{
  if (!TossimPacketModelC__initialized[sim_node()]) {
      sim_log_error(174U, "TossimPacketModelC", "TossimPacketModelC: Send.send() called, but not initialized!\n");
      return EOFF;
    }
  if (!TossimPacketModelC__running[sim_node()]) {
      sim_log_error(175U, "TossimPacketModelC", "TossimPacketModelC: Send.send() called, but not running!\n");
      return EOFF;
    }
...
#line 244
  sim_log_debug(187U, "CpmModelC,SNR", "SNR is %lf, PRR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
...
#line 129
  if (__nesc_ntoh_uint16(header->dest.nxdata) == TossimActiveMessageC__amAddress()) {
      sim_log_debug(167U, "Acks", "Received packet addressed to me so ack it\n");
      return TRUE;
    }
  return FALSE;
}
...
#line 299
      ...
      if (msg != TossimPacketModelC__sending[sim_node()]) {
          ...
          sim_log_debug(181U, "TossimPacketModelC", "Requested ack for 0x%x, but outgoing packet is 0x%x.\n", msg, TossimPacketModelC__sending[sim_node()]);
        }
    }
}
...
#line 162
  sim_log_debug(184U, "CpmModelC,SNRLoss", "SNR is %lf, ARR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
  ...
  if (isFull) 
    {
      ...
      sim_log_debug(246U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
...
inline static void SRTreeC__RoutingPacket__setPayloadLength(message_t * msg, uint8_t len){
#line 94
...
#line 94
# 103 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMPacket.nc"
inline static void SRTreeC__RoutingAMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC__AMPacket__setDestination(amsg, addr);
#line 103
}
...
#line 4
# 114 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void SRTreeC__NewEpochTimer__startPeriodicAt(uint32_t t0, uint32_t dt){
#line 114
...
#line 195
  sim_log_debug(51U, "SRTreeC", "RoutingMsgTimer fired!  radioBusy = %s \n", SRTreeC__RoutingSendBusy[sim_node()] ? "True" : "False");
  if (TOS_NODE_ID == 0) 
    {
      SRTreeC__roundCounter[sim_node()] += 1;

      sim_log_debug(52U, "Epoch", "################################################### \n");
      sim_log_debug(53U, "Epoch", "##############   ROUND   %u    #################### \n", SRTreeC__roundCounter[sim_node()]);
      sim_log_debug(54U, "Epoch", "###################################################\n");


      SRTreeC__tct[sim_node()] = rand() % 4;
      sim_log_debug(55U, "TCT", "TCT for round %u is %u\n", SRTreeC__roundCounter[sim_node()], (SRTreeC__tct[sim_node()] + 1) * 5);

      SRTreeC__agg_function[sim_node()] = 2;

      if (SRTreeC__agg_function[sim_node()] == 0) {
          sim_log_debug(56U, "aggregation_function", "Aggregation function for round %u is MAX\n", SRTreeC__roundCounter[sim_node()]);
        }
      else {
#line 212
        if (SRTreeC__agg_function[sim_node()] == 1) {
            sim_log_debug(57U, "aggregation_function", "Aggregation function for round %u is COUNT\n", SRTreeC__roundCounter[sim_node()]);
          }
        else 
#line 214
          {
            sim_log_debug(58U, "aggregation_function", "Aggregation function for round %u is MAX&COUNT\n", SRTreeC__roundCounter[sim_node()]);
          }
        }
      SRTreeC__NewEpochTimer__startPeriodicAt(-BOOT_TIME, TIMER_PERIOD_MILLI);
    }
  ...
  if (mrpkt == (void *)0) 
    {
      sim_log_debug(59U, "SRTreeC", "RoutingMsgTimer.fired(): No valid payload... \n");
      return;
    }
...
#line 234
    {
      ...
      __nesc_hton_uint8(mrpkt->parameters.nxdata, (SRTreeC__tct[sim_node()] << 4) | SRTreeC__agg_function[sim_node()]);
    }
#line 237
    __nesc_atomic_end(__nesc_atomic); }
  sim_log_debug(60U, "SRTreeC", "Sending RoutingMsg... \n");
  ...
  if (enqueueDone == SUCCESS) 
    {
      if (SRTreeC__RoutingSendQueue__size() == 1) 
        {
          sim_log_debug(61U, "SRTreeC", "SendTask() posted!!\n");
          SRTreeC__sendRoutingTask__postTask();
        }

      sim_log_debug(62U, "SRTreeC", "RoutingMsg enqueued successfully in SendingQueue!!!\n");
    }
  else 
    {
      sim_log_debug(63U, "SRTreeC", "RoutingMsg failed to be enqueued in SendingQueue!!!");
    }
}

# 5 "PacketQueue.nc"
inline static uint8_t SRTreeC__MeasureSendQueue__size(void ){
#line 5
  unsigned char __nesc_result;
#line 5

#line 5
  __nesc_result = /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__PacketQueue__size();
#line 5
...
inline static error_t SRTreeC__MeasureSendQueue__enqueue(message_t newVal){
#line 9
  unsigned char __nesc_result;
#line 9

#line 9
  __nesc_result = /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__PacketQueue__enqueue(newVal);
#line 9
...
#line 9
# 94 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Packet.nc"
inline static void SRTreeC__MeasurePacket__setPayloadLength(message_t * msg, uint8_t len){
#line 94
  TossimActiveMessageC__Packet__setPayloadLength(msg, len);
#line 94
}
#line 94
# 103 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMPacket.nc"
inline static void SRTreeC__MeasureAMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC__AMPacket__setDestination(amsg, addr);
#line 103
}
...
#line 38
    {
      if (/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__size[sim_node()] == 5) 
        {
          em = TRUE;
        }
      else 
...
# 4 "PacketQueue.nc"
inline static bool SRTreeC__MeasureSendQueue__full(void ){
#line 4
  unsigned char __nesc_result;
#line 4

#line 4
  __nesc_result = /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__PacketQueue__full();
#line 4
...
#line 26
    {
      em = /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__size[sim_node()] == 0;
    }
#line 28
    __nesc_atomic_end(__nesc_atomic); }
  return em;
...
# 3 "PacketQueue.nc"
inline static bool SRTreeC__AggregationReceiveQueue__empty(void ){
#line 3
  unsigned char __nesc_result;
#line 3

#line 3
  __nesc_result = /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__PacketQueue__empty();
#line 3
...
static inline void SRTreeC__StartMeasureTimer__fired(void )
{
  ...
  SRTreeC__sendAggChange[sim_node()] = FALSE;

  while (!SRTreeC__AggregationReceiveQueue__empty()) {
      sim_log_debug(102U, "ChangeAggrResult", "QUeeeeeeeeeeeeeeeeeeee\n");
      SRTreeC__AggregationReceiveQueue__dequeue();
    }

  while (!SRTreeC__AggregationSendQueue__empty()) {
      sim_log_debug(103U, "ChangeAggrResult", "Quuuuuuuuuuuuuuuuuuuuue\n");
      SRTreeC__AggregationSendQueue__dequeue();
    }

  if (!SRTreeC__sendAggChange[sim_node()]) 
    {
      sim_log_debug(104U, "ChangeAggrResult", "Node: %d changed sendAggChange to False...\n", TOS_NODE_ID);
    }

  for (SRTreeC__i[sim_node()] = 0; SRTreeC__i[sim_node()] < MAX_CHILDREN; SRTreeC__i[sim_node()]++) 
    {
      if (__nesc_ntoh_uint16(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].nodeID.nxdata) != 0) 
        {
          if (SRTreeC__i[sim_node()] == 0) 
            {
              sim_log_debug(105U, "Matrix", "Children Array of node %d\n", TOS_NODE_ID);
              sim_log_debug(106U, "Matrix", "---Child-MAX-COUNT---\n", __nesc_ntoh_uint16(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].nodeID.nxdata), __nesc_ntoh_uint8(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].max.nxdata), __nesc_ntoh_uint8(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].count.nxdata));
            }
          sim_log_debug(107U, "Matrix", "---| %d | %d | %d |-----\n", __nesc_ntoh_uint16(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].nodeID.nxdata), __nesc_ntoh_uint8(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].max.nxdata), __nesc_ntoh_uint8(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].count.nxdata));
        }
    }
  ...
  if (SRTreeC__agg_function[sim_node()] == 0) 
    {
      SRTreeC__max[sim_node()] = TRUE;
      SRTreeC__count[sim_node()] = FALSE;
      SRTreeC__count_change[sim_node()] = FALSE;
    }
  else {
    if (SRTreeC__agg_function[sim_node()] == 1) 
      {
        SRTreeC__count[sim_node()] = TRUE;
        SRTreeC__max[sim_node()] = FALSE;
        SRTreeC__max_change[sim_node()] = FALSE;
      }
    else 
      {
        SRTreeC__max[sim_node()] = TRUE;
  ...
  if (SRTreeC__max[sim_node()]) 
    {

      if (SRTreeC__meas_max[sim_node()] == 0) {

          SRTreeC__meas_max[sim_node()] = rand() % 80 + 1;
        }
      else {

          if (SRTreeC__meas_max[sim_node()] / 10 > 0) {
              SRTreeC__min_val[sim_node()] = SRTreeC__meas_max[sim_node()] - SRTreeC__meas_max[sim_node()] / 10;
              SRTreeC__max_val[sim_node()] = SRTreeC__meas_max[sim_node()] + SRTreeC__meas_max[sim_node()] / 10;
              SRTreeC__meas_max[sim_node()] = SRTreeC__min_val[sim_node()] + rand() % (SRTreeC__max_val[sim_node()] - SRTreeC__min_val[sim_node()]);
            }
        }

      sim_log_debug(108U, "Measures", "| Before agg. / No TiNA | Node: %d Depth: %d MAX: %d\n", TOS_NODE_ID, SRTreeC__curdepth[sim_node()], SRTreeC__meas_max[sim_node()]);


      SRTreeC__last_max[sim_node()] = SRTreeC__meas_max[sim_node()];
      ...
      for (SRTreeC__i[sim_node()] = 0; SRTreeC__i[sim_node()] < MAX_CHILDREN; SRTreeC__i[sim_node()]++) 
        {
          ...
          if (SRTreeC__meas_max[sim_node()] < __nesc_ntoh_uint8(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].max.nxdata) && SRTreeC__last_max[sim_node()] < __nesc_ntoh_uint8(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].max.nxdata)) {
            SRTreeC__last_max[sim_node()] = __nesc_ntoh_uint8(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].max.nxdata);
            }
        }
#line 736
      sim_log_debug(109U, "Measures", "| After agg. / No TiNA  | Node: %d Depth: %d MAX: %d\n.........................................\n", TOS_NODE_ID, SRTreeC__curdepth[sim_node()], SRTreeC__last_max[sim_node()]);
    }

  if (SRTreeC__count[sim_node()]) 
    {
      SRTreeC__last_count[sim_node()] = 1;
      ...
      for (SRTreeC__i[sim_node()] = 0; SRTreeC__i[sim_node()] < MAX_CHILDREN; SRTreeC__i[sim_node()]++) 
        {
          ...
          SRTreeC__last_count[sim_node()] += __nesc_ntoh_uint8(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].count.nxdata);
        }
      sim_log_debug(110U, "Measures", "| After agg. / No TiNA  | Node: %d Depth: %d COUNT: %d\n.........................................\n", TOS_NODE_ID, SRTreeC__curdepth[sim_node()], SRTreeC__last_count[sim_node()]);
    }
  ...
  if (SRTreeC__max[sim_node()]) 
    {
      ...
      if (SRTreeC__last_tina_max[sim_node()] != 0) {
        meas_diff = abs(SRTreeC__last_tina_max[sim_node()] - SRTreeC__last_max[sim_node()]) * 100 / SRTreeC__last_tina_max[sim_node()];
        }
      if (meas_diff > (SRTreeC__tct[sim_node()] + 1) * 5 || SRTreeC__last_tina_max[sim_node()] == 0) 
        {
          SRTreeC__tina_condition[sim_node()] = TRUE;
          SRTreeC__max_change[sim_node()] = TRUE;
          sim_log_debug(111U, "Tina", "| ****PASSED TiNA**** | Node: %d Last MAX: %d New MAX: %d\n", TOS_NODE_ID, SRTreeC__last_tina_max[sim_node()], SRTreeC__last_max[sim_node()]);
          SRTreeC__last_tina_max[sim_node()] = SRTreeC__last_max[sim_node()];
        }
      else 
        {
          SRTreeC__max_change[sim_node()] = FALSE;
  ...
  if (SRTreeC__count[sim_node()]) 
    {
      ...
      if (SRTreeC__last_tina_count[sim_node()] != 0) {
        meas_diff = abs(SRTreeC__last_tina_count[sim_node()] - SRTreeC__last_count[sim_node()]) * 100 / SRTreeC__last_tina_count[sim_node()];
        }
      if (meas_diff > (SRTreeC__tct[sim_node()] + 1) * 5 || SRTreeC__last_tina_count[sim_node()] == 0) 
        {
          SRTreeC__tina_condition[sim_node()] = TRUE;
          SRTreeC__count_change[sim_node()] = TRUE;
          sim_log_debug(112U, "Tina", "| ****PASSED TiNA**** | Node: %d Last COUNT: %d New COUNT: %d\n", TOS_NODE_ID, SRTreeC__last_tina_count[sim_node()], SRTreeC__last_count[sim_node()]);
          SRTreeC__last_tina_count[sim_node()] = SRTreeC__last_count[sim_node()];
        }
      else 
        {
          SRTreeC__count_change[sim_node()] = FALSE;
  ...
  if (!(SRTreeC__count_change[sim_node()] || SRTreeC__max_change[sim_node()])) {
    SRTreeC__tina_condition[sim_node()] = FALSE;
    }
  if (SRTreeC__MeasureSendQueue__full()) 
    {
      return;
    }


  if (SRTreeC__tina_condition[sim_node()] && TOS_NODE_ID != 0 && !(SRTreeC__max_change[sim_node()] && SRTreeC__count_change[sim_node()])) 
    {
      ommpkt = (OneMeasMsg *)SRTreeC__MeasurePacket__getPayload(&tmp, sizeof(OneMeasMsg ));
      if (ommpkt == (void *)0) 
        {
          sim_log_debug(113U, "MeasureMsg", "StartMeasureTimer.fired(): No valid payload... \n");
          return;
        }
      if (SRTreeC__max_change[sim_node()]) 
        {
          { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 815
            {
              __nesc_hton_uint8(ommpkt->measurement.nxdata, SRTreeC__last_tina_max[sim_node()]);
            }
#line 817
            __nesc_atomic_end(__nesc_atomic); }
          sim_log_debug(114U, "Tina", "|  ****SEND TiNA****  | Node: %d MAX: %d\n", TOS_NODE_ID, SRTreeC__last_tina_max[sim_node()]);
        }
      if (SRTreeC__count_change[sim_node()]) 
        {
          { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 822
            {
              __nesc_hton_uint8(ommpkt->measurement.nxdata, SRTreeC__last_tina_count[sim_node()] | (1 << 8));
            }
#line 824
            __nesc_atomic_end(__nesc_atomic); }
          sim_log_debug(115U, "Tina", "|  ****SEND TiNA****  | Node: %d COUNT: %d\n", TOS_NODE_ID, SRTreeC__last_tina_count[sim_node()]);
        }
      sim_log_debug(116U, "Tina", "|  ****SEND TiNA****  | Sending ONE MEAS\n*****************************************\n");
      sim_log_debug(117U, "MeasureMsg", "Sending MeasureMsg... \n");

      SRTreeC__MeasureAMPacket__setDestination(&tmp, SRTreeC__parentID[sim_node()]);
      SRTreeC__MeasurePacket__setPayloadLength(&tmp, sizeof(OneMeasMsg ));

      enqueueDone = SRTreeC__MeasureSendQueue__enqueue(tmp);

      if (enqueueDone == SUCCESS) 
        {
          if (SRTreeC__MeasureSendQueue__size() == 1) 
            {
              sim_log_debug(118U, "MeasureMsg", "SendTask() posted!!\n");
              SRTreeC__sendMeasMsg__postTask();
            }

          sim_log_debug(119U, "MeasureMsg", "MeasMsg enqueued successfully in MeasureSendQueue!!!\n");
        }
    }
  else {
    ...
    if (SRTreeC__tina_condition[sim_node()] && TOS_NODE_ID != 0 && SRTreeC__max_change[sim_node()] && SRTreeC__count_change[sim_node()]) 
      {
        tmmpkt = (TwoMeasMsg *)SRTreeC__MeasurePacket__getPayload(&tmp, sizeof(TwoMeasMsg ));
        if (tmmpkt == (void *)0) 
          {
            sim_log_debug(120U, "MeasureMsg", "StartMeasureTimer.fired(): No valid payload... \n");
            return;
          }
...
#line 857
          {
            __nesc_hton_uint8(tmmpkt->count.nxdata, SRTreeC__last_tina_count[sim_node()]);
            __nesc_hton_uint8(tmmpkt->max.nxdata, SRTreeC__last_tina_max[sim_node()]);
          }
#line 860
          __nesc_atomic_end(__nesc_atomic); }
        sim_log_debug(121U, "Tina", "|  ****SEND TiNA****  | Node: %d MAX: %d\n", TOS_NODE_ID, SRTreeC__last_tina_max[sim_node()]);
        sim_log_debug(122U, "Tina", "|  ****SEND TiNA****  | Node: %d COUNT: %d\n", TOS_NODE_ID, SRTreeC__last_tina_count[sim_node()]);
        sim_log_debug(123U, "Tina", "|  ****SEND TiNA****  | Sending TWO MEAS\n*****************************************\n");
        sim_log_debug(124U, "MeasureMsg", "Sending MeasureMsg... \n");

        SRTreeC__MeasureAMPacket__setDestination(&tmp, SRTreeC__parentID[sim_node()]);
        SRTreeC__MeasurePacket__setPayloadLength(&tmp, sizeof(TwoMeasMsg ));
        ...
        for (SRTreeC__i[sim_node()] = 0; SRTreeC__i[sim_node()] < MAX_CHILDREN; SRTreeC__i[sim_node()]++) 
          {
            if (__nesc_ntoh_uint16(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].nodeID.nxdata) != 0) {
              sim_log_debug(125U, "Matrix", "Children values: %d %d %d\n", __nesc_ntoh_uint16(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].nodeID.nxdata), __nesc_ntoh_uint8(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].max.nxdata), __nesc_ntoh_uint8(SRTreeC__children_values[sim_node()][SRTreeC__i[sim_node()]].count.nxdata));
              }
          }
        if (enqueueDone == SUCCESS) 
          {
            if (SRTreeC__MeasureSendQueue__size() == 1) 
              {
                sim_log_debug(126U, "MeasureMsg", "SendTask() posted!!\n");
                SRTreeC__sendMeasMsg__postTask();
              }

            sim_log_debug(127U, "MeasureMsg", "MeasMsg enqueued successfully in MeasureSendQueue!!!\n");
          }
      }
    else {
      if (TOS_NODE_ID == 0) 
        {
          if (SRTreeC__max[sim_node()]) {
            sim_log_debug(128U, "Result", "^^^^^^^^^^^Result of MAX for epoch %d: %d^^^^^^^^^^^\n\n\n", SRTreeC__roundCounter[sim_node()], SRTreeC__last_tina_max[sim_node()]);
            }
#line 893
          if (SRTreeC__count[sim_node()]) {
            sim_log_debug(129U, "Result", "^^^^^^^^^^^Result of COUNT for epoch %d: %d^^^^^^^^^^^\n\n\n", SRTreeC__roundCounter[sim_node()], SRTreeC__last_tina_count[sim_node()]);
            }
        }
      }
    }
...
static inline void SRTreeC__NewEpochTimer__fired(void )
{
  ...
  SRTreeC__p[sim_node()] = rand() % 100;
  if (SRTreeC__agg_function[sim_node()] == 2) {
      SRTreeC__agg_change[sim_node()] = TRUE;
      SRTreeC__sendAggChange[sim_node()] = TRUE;
      SRTreeC__agg_function[sim_node()] = 0;
    }
  else {
#line 272
    if (SRTreeC__agg_function[sim_node()] == 0) {
        SRTreeC__agg_change[sim_node()] = TRUE;
        SRTreeC__sendAggChange[sim_node()] = TRUE;
        SRTreeC__agg_function[sim_node()] = 1;
      }
    else {
      SRTreeC__agg_change[sim_node()] = FALSE;
      }
    }
#line 297
  sim_log_debug(64U, "Epoch", "################################################### \n");
  sim_log_debug(65U, "Epoch", "##############   ROUND   %u    #################### \n", SRTreeC__roundCounter[sim_node()]);
  sim_log_debug(66U, "Epoch", "###################################################\n");
  if (SRTreeC__agg_change[sim_node()]) 
    {
      sim_log_debug(67U, "ChangeAggrResult", "Aggregation function changed to: %d for period: %d\n", SRTreeC__agg_function[sim_node()], SRTreeC__roundCounter[sim_node()]);
      SRTreeC__NewAggTimer__startOneShot(TIMER_FAST_PERIOD);
    }
}
...
#line 58
    {
      ms = /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__size[sim_node()];
    }
#line 60
    __nesc_atomic_end(__nesc_atomic); }
  return ms;
...
# 5 "PacketQueue.nc"
inline static uint8_t SRTreeC__AggregationSendQueue__size(void ){
#line 5
  unsigned char __nesc_result;
#line 5

#line 5
  __nesc_result = /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__PacketQueue__size();
#line 5
...
#line 93
    {
      ...
      wasEmpty = /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__size[sim_node()] == 0;

      isFull = /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__size[sim_node()] == 5;
    }
#line 98
    __nesc_atomic_end(__nesc_atomic); }
      ...
      if (!wasEmpty) 
        {
          ...
          /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__tailIndex[sim_node()] = (/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__tailIndex[sim_node()] + 1) % 5;
        }


      memcpy(&/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__Q[sim_node()][/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__tailIndex[sim_node()]], &newPkt, sizeof(message_t ));

      /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__size[sim_node()]++;
    }
#line 124
    __nesc_atomic_end(__nesc_atomic); }

  sim_log_debug(263U, "PacketQueueC", "enqueue(): Enqueued in pos= %u \n", /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__tailIndex[sim_node()]);
...
# 9 "PacketQueue.nc"
inline static error_t SRTreeC__AggregationSendQueue__enqueue(message_t newVal){
#line 9
  unsigned char __nesc_result;
#line 9

#line 9
  __nesc_result = /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__PacketQueue__enqueue(newVal);
#line 9
...
#line 9
# 94 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Packet.nc"
inline static void SRTreeC__AggregationPacket__setPayloadLength(message_t * msg, uint8_t len){
#line 94
  TossimActiveMessageC__Packet__setPayloadLength(msg, len);
#line 94
}
#line 94
# 103 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMPacket.nc"
inline static void SRTreeC__AggregationAMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC__AMPacket__setDestination(amsg, addr);
#line 103
}
...
#line 38
    {
      if (/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__size[sim_node()] == 5) 
        {
          em = TRUE;
        }
      else 
...
# 4 "PacketQueue.nc"
inline static bool SRTreeC__AggregationSendQueue__full(void ){
#line 4
  unsigned char __nesc_result;
#line 4

#line 4
  __nesc_result = /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__PacketQueue__full();
#line 4
...
#line 1039
  sim_log_debug(145U, "ChangeAggr", "NewAggTimer.fired()!\n");

  if (!SRTreeC__sendAggChange[sim_node()]) 
    {
      sim_log_debug(146U, "ChangeAggrResult", "Node: %d sendAggChange False...\n", TOS_NODE_ID);
    }

  if (SRTreeC__AggregationSendQueue__full()) 
    {
      return;
    }

  ampkt = (AggMessage *)SRTreeC__AggregationPacket__getPayload(&tmp, sizeof(AggMessage ));
  if (ampkt == (void *)0) 
    {
      sim_log_debug(147U, "ChangeAggr", "NewAggTimer.fired(): No valid payload... \n");
      return;
    }

  __nesc_hton_uint8(ampkt->agg_msg.nxdata, SRTreeC__agg_function[sim_node()]);

  sim_log_debug(148U, "ChangeAggrResult", "Node: %d Agg Function: %d, %d\n", TOS_NODE_ID, SRTreeC__agg_function[sim_node()], __nesc_ntoh_uint8(ampkt->agg_msg.nxdata));
  sim_log_debug(149U, "ChangeAggr", "Sending AggMessage... \n");

  SRTreeC__AggregationAMPacket__setDestination(&tmp, AM_BROADCAST_ADDR);
  SRTreeC__AggregationPacket__setPayloadLength(&tmp, sizeof(AggMessage ));

  enqueueDone = SRTreeC__AggregationSendQueue__enqueue(tmp);

  if (enqueueDone == SUCCESS) 
    {
      if (SRTreeC__AggregationSendQueue__size() == 1) 
        {
          sim_log_debug(150U, "ChangeAggr", "SendTask() posted!!\n");
          SRTreeC__sendAggregationTask__postTask();
        }

      sim_log_debug(151U, "ChangeAggr", "AggMessage enqueued successfully in SendingQueue!!!\n");
    }
  else 
    {
      sim_log_debug(152U, "ChangeAggr", "AggMessage failed to be enqueued in SendingQueue!!!");
    }
}
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f585304c108){
#line 83
  switch (arg_0x7f585304c108) {
#line 83
    case 0U:
#line 83
...
#line 83
    case 1U:
#line 83
      SRTreeC__StartMeasureTimer__fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      SRTreeC__NewEpochTimer__fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      SRTreeC__NewAggTimer__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f585304c108);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(240U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP__compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP__overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(239U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP__overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(236U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(237U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(229U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(219U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 194
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << OCIE0)) != 0) {
          ...
          sim_log_debug(224U, "HplAtm128Timer0AsyncP", "TIFR is %hhx\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x36]);
          sim_log_debug(225U, "HplAtm128Timer0AsyncP", "Compare interrupt @ %s\n", timeStr);
          INTERRUPT_15();
        }
      else {
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << OCF0;
...
#line 225
  sim_log_debug(226U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 45
{
  sim_log_debug(153U, "PlatformC", "Initialized mote.\n");
  return SUCCESS;
}
...
#line 86
{
  sim_log_debug(169U, "TossimPacketModelC", "TossimPacketModelC: Init.init() called\n");
...
#line 364
{
  sim_log_debug(231U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
static inline void SRTreeC__Boot__booted(void )
{
  ...
  SRTreeC__urandom_file[sim_node()] = fopen("/dev/urandom", "r");
  fread(&SRTreeC__seed[sim_node()], sizeof SRTreeC__seed[sim_node()], 1, SRTreeC__urandom_file[sim_node()]);
  fclose(SRTreeC__urandom_file[sim_node()]);
  srand(SRTreeC__seed[sim_node()]);
  ...
  if (TOS_NODE_ID == 0) 
  ...
  else 
    {
      ...
      sim_log_debug(47U, "Boot", "curdepth = %d  ,  parentID= %d \n", SRTreeC__curdepth[sim_node()], SRTreeC__parentID[sim_node()]);
    }
}
...
#line 211
  ...
  sim_log_debug(163U, "SimMoteP", "Turning on mote %i at time %s.\n", (int )sim_node(), buf);
...
#line 210
    __nesc_atomic_end(__nesc_atomic); }
  if (result == SUCCESS) {
      sim_log_debug(158U, "Scheduler", "Posting task %hhu.\n", id);
      SimSchedulerBasicP__sim_scheduler_submit_event();
    }
  else {
      sim_log_debug(159U, "Scheduler", "Posting task %hhu, but already posted.\n", id);
    }
  return result;
}
...
#line 75
  ...
  sim_log_debug(154U, "SimMainP", "Mote %li signaling boot at time %s.\n", sim_node(), timeBuf);
  ...
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
    {
      ...
      if (nextTask == SimSchedulerBasicP__NO_TASK) 
        {
          sim_log_debug(156U, "Scheduler", "Told to run next task, but no task to run.\n");
          {
...
#line 193
    __nesc_atomic_end(__nesc_atomic); }
#line 192
  sim_log_debug(157U, "Scheduler", "Running task %hhu.\n", nextTask);
...
#line 26
    {
      em = /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__size[sim_node()] == 0;
    }
#line 28
    __nesc_atomic_end(__nesc_atomic); }
  return em;
...
#line 26
    {
      em = /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__size[sim_node()] == 0;
    }
#line 28
    __nesc_atomic_end(__nesc_atomic); }
  return em;
...
#line 308
  if (TOS_NODE_ID == 0) 
    {
      sim_log_debug(68U, "Routing result", "----------------------------\n");
      sim_log_debug(69U, "Routing result", "|------ROUTING RESULT------|\n");
    }
  else 
    {
      sim_log_debug(70U, "Routing result", "|          %d => %d          |\n", TOS_NODE_ID, SRTreeC__parentID[sim_node()]);
    }

  sim_log_debug(71U, "SRTreeC", "A Routing package sent... %s \n", err == SUCCESS ? "True" : "False");

  sim_log_debug(72U, "SRTreeC", "Package sent %s \n", err == SUCCESS ? "True" : "False");
  SRTreeC__setRoutingSendBusy(FALSE);
...
#line 124
    {
      SRTreeC__RoutingSendBusy[sim_node()] = state;
    }
#line 126
    __nesc_atomic_end(__nesc_atomic); }
  if (state == TRUE) 
...
#line 78
  sim_log_debug(164U, "AM", "AM: Sending packet (id=%hhu, len=%hhu) to %hu\n", id, len, addr);
...
#line 294
  noise = pow(10.0, noise / 10.0);
  while (list != (void *)0) {
      sim_log_debug(190U, "CpmModelC", "packetReceive: outstanding from %d\n", list->source);
      count++;
  ...
  noise = 10.0 * log(noise) / log(10.0);
  sim_log_debug(191U, "CpmModelC", "packetReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
  return noise;
}
...
#line 131
{
  ...
  sim_log_debug(182U, "CpmModelC", "IN: noise_hash_generation()\n");
  ...
  sim_log_debug(183U, "CpmModelC,Tal", "%s: OUT: noise_hash_generation(): %lf\n", sim_time_string(), noise_val);
...
#line 285
  ...
  sim_log_debug(228U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(234U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 143
    {
      isEmpty = /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__size[sim_node()] == 0;
    }
#line 145
    __nesc_atomic_end(__nesc_atomic); }
...
#line 155
        {
          m = /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__Q[sim_node()][/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__headIndex[sim_node()]];
        }
#line 157
        __nesc_atomic_end(__nesc_atomic); }
      return m;
...
#line 162
    {
      tmp = /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__headIndex[sim_node()];

      if (/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__tailIndex[sim_node()] != /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__headIndex[sim_node()]) 
        {


          /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__headIndex[sim_node()] = (/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__headIndex[sim_node()] + 1) % 3;
        }

      /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__size[sim_node()]--;

      m = /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__Q[sim_node()][tmp];
    }
#line 175
    __nesc_atomic_end(__nesc_atomic); }
...
#line 143
    {
      isEmpty = /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__size[sim_node()] == 0;
    }
#line 145
    __nesc_atomic_end(__nesc_atomic); }
...
#line 155
        {
          m = /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__Q[sim_node()][/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__headIndex[sim_node()]];
        }
#line 157
        __nesc_atomic_end(__nesc_atomic); }
      return m;
...
#line 162
    {
      tmp = /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__headIndex[sim_node()];

      if (/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__tailIndex[sim_node()] != /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__headIndex[sim_node()]) 
        {


          /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__headIndex[sim_node()] = (/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__headIndex[sim_node()] + 1) % 5;
        }

      /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__size[sim_node()]--;

      m = /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__Q[sim_node()][tmp];
    }
#line 175
    __nesc_atomic_end(__nesc_atomic); }
...
#line 93
    {
      ...
      wasEmpty = /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__size[sim_node()] == 0;

      isFull = /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__size[sim_node()] == 5;
    }
#line 98
    __nesc_atomic_end(__nesc_atomic); }
  ...
  if (isFull) 
    {
      ...
      sim_log_debug(254U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
      ...
      if (!wasEmpty) 
        {
          ...
          /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__tailIndex[sim_node()] = (/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__tailIndex[sim_node()] + 1) % 5;
        }


      memcpy(&/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__Q[sim_node()][/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__tailIndex[sim_node()]], &newPkt, sizeof(message_t ));
...
#line 124
  ...
  sim_log_debug(255U, "PacketQueueC", "enqueue(): Enqueued in pos= %u \n", /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__tailIndex[sim_node()]);
...
#line 58
    {
      ms = /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__size[sim_node()];
    }
#line 60
    __nesc_atomic_end(__nesc_atomic); }
  return ms;
...
#line 101
      sim_log_debug(214U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) {
              sim_log_debug(215U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(216U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__set[sim_node()]) {
          ...
          sim_log_debug(217U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(235U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(238U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(227U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
...
{
  if (!TossimPacketModelC__initialized[sim_node()]) {
      sim_log_error(170U, "TossimPacketModelC", "TossimPacketModelC: Control.start() called before initialization!\n");
      return FAIL;
    }
  sim_log_debug(171U, "TossimPacketModelC", "TossimPacketModelC: Control.start() called.\n");
  TossimPacketModelC__startDoneTask__postTask();
  return SUCCESS;
}

# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Packet.nc"
static uint8_t SRTreeC__AggregationPacket__payloadLength(message_t * msg){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 91
{
  ...
  sim_log_debug(241U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] >= 3) {
      ...
      sim_log_debug(242U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(243U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
          /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] = 3;
      ...
      sim_log_debug(244U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}

# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Packet.nc"
static uint8_t SRTreeC__RoutingPacket__payloadLength(message_t * msg){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
static uint8_t SRTreeC__MeasurePacket__payloadLength(message_t * msg){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 170
  ...
  sim_log_debug(161U, "SimMoteP", "Fetched %s of %i to be %p with len %i (result %i)\n", name, mote, *ptr, *len, result);
  sim_set_node(tmpID);
  return result;
}
...
#line 179
  ...
  sim_log_debug(162U, "SimMoteP", "Setting start time to %llu\n", SimMoteP__startTime[sim_node()]);
  sim_set_node(tmpID);
  return;
}
...
#line 124
{
  if (!SimMoteP__isOn[sim_node()]) {
      ...
      sim_log_debug(160U, "SimMoteP", "Setting start time to %llu\n", SimMoteP__startTime[sim_node()]);
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "SRTreeC__rand_num"))
  {
    *addr = (uintptr_t)&SRTreeC__rand_num[__nesc_mote];
    *size = sizeof(SRTreeC__rand_num[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "SRTreeC__radioMeasMsgSendPkt"))
  {
    *addr = (uintptr_t)&SRTreeC__radioMeasMsgSendPkt[__nesc_mote];
    *size = sizeof(SRTreeC__radioMeasMsgSendPkt[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__radioAggrMsgSendPkt"))
  {
    *addr = (uintptr_t)&SRTreeC__radioAggrMsgSendPkt[__nesc_mote];
    *size = sizeof(SRTreeC__radioAggrMsgSendPkt[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__RoutingSendBusy"))
  {
    *addr = (uintptr_t)&SRTreeC__RoutingSendBusy[__nesc_mote];
    *size = sizeof(SRTreeC__RoutingSendBusy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__MeasureSendBusy"))
  {
    *addr = (uintptr_t)&SRTreeC__MeasureSendBusy[__nesc_mote];
    *size = sizeof(SRTreeC__MeasureSendBusy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__AggregationSendBusy"))
  {
    *addr = (uintptr_t)&SRTreeC__AggregationSendBusy[__nesc_mote];
    *size = sizeof(SRTreeC__AggregationSendBusy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__MeasureTimerSet"))
  {
    *addr = (uintptr_t)&SRTreeC__MeasureTimerSet[__nesc_mote];
    *size = sizeof(SRTreeC__MeasureTimerSet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__lostRoutingSendTask"))
  {
    *addr = (uintptr_t)&SRTreeC__lostRoutingSendTask[__nesc_mote];
    *size = sizeof(SRTreeC__lostRoutingSendTask[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__lostRoutingRecTask"))
  {
    *addr = (uintptr_t)&SRTreeC__lostRoutingRecTask[__nesc_mote];
    *size = sizeof(SRTreeC__lostRoutingRecTask[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__tina_condition"))
  {
    *addr = (uintptr_t)&SRTreeC__tina_condition[__nesc_mote];
    *size = sizeof(SRTreeC__tina_condition[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__max"))
  {
    *addr = (uintptr_t)&SRTreeC__max[__nesc_mote];
    *size = sizeof(SRTreeC__max[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__count"))
  {
    *addr = (uintptr_t)&SRTreeC__count[__nesc_mote];
    *size = sizeof(SRTreeC__count[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__max_change"))
  {
    *addr = (uintptr_t)&SRTreeC__max_change[__nesc_mote];
    *size = sizeof(SRTreeC__max_change[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__count_change"))
  {
    *addr = (uintptr_t)&SRTreeC__count_change[__nesc_mote];
    *size = sizeof(SRTreeC__count_change[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__agg_change"))
  {
    *addr = (uintptr_t)&SRTreeC__agg_change[__nesc_mote];
    *size = sizeof(SRTreeC__agg_change[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__sendAggChange"))
  {
    *addr = (uintptr_t)&SRTreeC__sendAggChange[__nesc_mote];
    *size = sizeof(SRTreeC__sendAggChange[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "SRTreeC__agg_function"))
  {
    *addr = (uintptr_t)&SRTreeC__agg_function[__nesc_mote];
    *size = sizeof(SRTreeC__agg_function[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__min_val"))
  {
    *addr = (uintptr_t)&SRTreeC__min_val[__nesc_mote];
    *size = sizeof(SRTreeC__min_val[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__max_val"))
  {
    *addr = (uintptr_t)&SRTreeC__max_val[__nesc_mote];
    *size = sizeof(SRTreeC__max_val[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__i"))
  {
    *addr = (uintptr_t)&SRTreeC__i[__nesc_mote];
    *size = sizeof(SRTreeC__i[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__seed"))
  {
    *addr = (uintptr_t)&SRTreeC__seed[__nesc_mote];
    *size = sizeof(SRTreeC__seed[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__last_max"))
  {
    *addr = (uintptr_t)&SRTreeC__last_max[__nesc_mote];
    *size = sizeof(SRTreeC__last_max[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__last_count"))
  {
    *addr = (uintptr_t)&SRTreeC__last_count[__nesc_mote];
    *size = sizeof(SRTreeC__last_count[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__last_tina_max"))
  {
    *addr = (uintptr_t)&SRTreeC__last_tina_max[__nesc_mote];
    *size = sizeof(SRTreeC__last_tina_max[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__last_tina_count"))
  {
    *addr = (uintptr_t)&SRTreeC__last_tina_count[__nesc_mote];
    *size = sizeof(SRTreeC__last_tina_count[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__meas_max"))
  {
    *addr = (uintptr_t)&SRTreeC__meas_max[__nesc_mote];
    *size = sizeof(SRTreeC__meas_max[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__sim"))
  {
    *addr = (uintptr_t)&SRTreeC__sim[__nesc_mote];
    *size = sizeof(SRTreeC__sim[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__p"))
  {
    *addr = (uintptr_t)&SRTreeC__p[__nesc_mote];
    *size = sizeof(SRTreeC__p[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__urandom_file"))
  {
    *addr = (uintptr_t)&SRTreeC__urandom_file[__nesc_mote];
    *size = sizeof(SRTreeC__urandom_file[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__children_values"))
  {
    *addr = (uintptr_t)&SRTreeC__children_values[__nesc_mote];
    *size = sizeof(SRTreeC__children_values[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__Q"))
  {
    *addr = (uintptr_t)&/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__Q[__nesc_mote];
    *size = sizeof(/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__Q[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__headIndex"))
  {
    *addr = (uintptr_t)&/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__headIndex[__nesc_mote];
    *size = sizeof(/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__headIndex[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__tailIndex"))
  {
    *addr = (uintptr_t)&/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__tailIndex[__nesc_mote];
    *size = sizeof(/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__tailIndex[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__size"))
  {
    *addr = (uintptr_t)&/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__size[__nesc_mote];
    *size = sizeof(/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__size[__nesc_mote]);
    return 0;
  }

  /* Module PacketQueueC__3 */
  if (!strcmp(varname, "/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__Q"))
  {
    *addr = (uintptr_t)&/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__Q[__nesc_mote];
    *size = sizeof(/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__Q[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__headIndex"))
  {
    *addr = (uintptr_t)&/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__headIndex[__nesc_mote];
    *size = sizeof(/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__headIndex[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__tailIndex"))
  {
    *addr = (uintptr_t)&/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__tailIndex[__nesc_mote];
    *size = sizeof(/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__tailIndex[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__size"))
  {
    *addr = (uintptr_t)&/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__size[__nesc_mote];
    *size = sizeof(/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__size[__nesc_mote]);
    return 0;
  }

  /* Module AMQueueEntryP__2 */

  /* Module PacketQueueC__4 */
  if (!strcmp(varname, "/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__Q"))
  {
    *addr = (uintptr_t)&/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__Q[__nesc_mote];
    *size = sizeof(/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__Q[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__headIndex"))
  {
    *addr = (uintptr_t)&/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__headIndex[__nesc_mote];
    *size = sizeof(/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__headIndex[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__tailIndex"))
  {
    *addr = (uintptr_t)&/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__tailIndex[__nesc_mote];
    *size = sizeof(/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__tailIndex[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__size"))
  {
    *addr = (uintptr_t)&/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__size[__nesc_mote];
    *size = sizeof(/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__size[__nesc_mote]);
    return 0;
  }

  /* Module PacketQueueC__5 */
  if (!strcmp(varname, "/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__Q"))
  {
    *addr = (uintptr_t)&/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__Q[__nesc_mote];
    *size = sizeof(/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__Q[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__headIndex"))
  {
    *addr = (uintptr_t)&/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__headIndex[__nesc_mote];
    *size = sizeof(/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__headIndex[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__tailIndex"))
  {
    *addr = (uintptr_t)&/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__tailIndex[__nesc_mote];
    *size = sizeof(/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__tailIndex[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__size"))
  {
    *addr = (uintptr_t)&/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__size[__nesc_mote];
    *size = sizeof(/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__size[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&SRTreeC__rand_num[__nesc_mote], 0, sizeof SRTreeC__rand_num[__nesc_mote]);
  memset((void *)&SRTreeC__radioRoutingSendPkt[__nesc_mote], 0, sizeof SRTreeC__radioRoutingSendPkt[__nesc_mote]);
  memset((void *)&SRTreeC__radioMeasMsgSendPkt[__nesc_mote], 0, sizeof SRTreeC__radioMeasMsgSendPkt[__nesc_mote]);
  memset((void *)&SRTreeC__radioAggrMsgSendPkt[__nesc_mote], 0, sizeof SRTreeC__radioAggrMsgSendPkt[__nesc_mote]);
  SRTreeC__RoutingSendBusy[__nesc_mote] = FALSE;
  SRTreeC__MeasureSendBusy[__nesc_mote] = FALSE;
  SRTreeC__AggregationSendBusy[__nesc_mote] = FALSE;
  SRTreeC__MeasureTimerSet[__nesc_mote] = FALSE;
  SRTreeC__lostRoutingSendTask[__nesc_mote] = FALSE;
  SRTreeC__lostRoutingRecTask[__nesc_mote] = FALSE;
  SRTreeC__tina_condition[__nesc_mote] = FALSE;
  SRTreeC__max[__nesc_mote] = FALSE;
  SRTreeC__count[__nesc_mote] = FALSE;
  SRTreeC__max_change[__nesc_mote] = FALSE;
  SRTreeC__count_change[__nesc_mote] = FALSE;
  SRTreeC__agg_change[__nesc_mote] = FALSE;
  SRTreeC__sendAggChange[__nesc_mote] = FALSE;
  ...
  memset((void *)&SRTreeC__agg_function[__nesc_mote], 0, sizeof SRTreeC__agg_function[__nesc_mote]);
  memset((void *)&SRTreeC__min_val[__nesc_mote], 0, sizeof SRTreeC__min_val[__nesc_mote]);
  memset((void *)&SRTreeC__max_val[__nesc_mote], 0, sizeof SRTreeC__max_val[__nesc_mote]);
  memset((void *)&SRTreeC__i[__nesc_mote], 0, sizeof SRTreeC__i[__nesc_mote]);
  memset((void *)&SRTreeC__seed[__nesc_mote], 0, sizeof SRTreeC__seed[__nesc_mote]);
  memset((void *)&SRTreeC__last_max[__nesc_mote], 0, sizeof SRTreeC__last_max[__nesc_mote]);
  memset((void *)&SRTreeC__last_count[__nesc_mote], 0, sizeof SRTreeC__last_count[__nesc_mote]);
  memset((void *)&SRTreeC__last_tina_max[__nesc_mote], 0, sizeof SRTreeC__last_tina_max[__nesc_mote]);
  memset((void *)&SRTreeC__last_tina_count[__nesc_mote], 0, sizeof SRTreeC__last_tina_count[__nesc_mote]);
  memset((void *)&SRTreeC__meas_max[__nesc_mote], 0, sizeof SRTreeC__meas_max[__nesc_mote]);
  memset((void *)&SRTreeC__sim[__nesc_mote], 0, sizeof SRTreeC__sim[__nesc_mote]);
  memset((void *)&SRTreeC__p[__nesc_mote], 0, sizeof SRTreeC__p[__nesc_mote]);
  memset((void *)&SRTreeC__urandom_file[__nesc_mote], 0, sizeof SRTreeC__urandom_file[__nesc_mote]);
  memset((void *)&SRTreeC__children_values[__nesc_mote], 0, sizeof SRTreeC__children_values[__nesc_mote]);
  ...
  /* Module PacketQueueC__2 */
  memset((void *)&/*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__Q[__nesc_mote], 0, sizeof /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__Q[__nesc_mote]);
  /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__headIndex[__nesc_mote] = 0;
  /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__tailIndex[__nesc_mote] = 0;
  /*SRTreeAppC.MeasureSendQueueC*/PacketQueueC__2__size[__nesc_mote] = 0;

  /* Module PacketQueueC__3 */
  memset((void *)&/*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__Q[__nesc_mote], 0, sizeof /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__Q[__nesc_mote]);
  /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__headIndex[__nesc_mote] = 0;
  /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__tailIndex[__nesc_mote] = 0;
  /*SRTreeAppC.MeasureReceiveQueueC*/PacketQueueC__3__size[__nesc_mote] = 0;

  /* Module AMQueueEntryP__2 */

  /* Module PacketQueueC__4 */
  memset((void *)&/*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__Q[__nesc_mote], 0, sizeof /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__Q[__nesc_mote]);
  /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__headIndex[__nesc_mote] = 0;
  /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__tailIndex[__nesc_mote] = 0;
  /*SRTreeAppC.AggregationSendQueueC*/PacketQueueC__4__size[__nesc_mote] = 0;

  /* Module PacketQueueC__5 */
  memset((void *)&/*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__Q[__nesc_mote], 0, sizeof /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__Q[__nesc_mote]);
  /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__headIndex[__nesc_mote] = 0;
  /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__tailIndex[__nesc_mote] = 0;
  /*SRTreeAppC.AggregationReceiveQueueC*/PacketQueueC__5__size[__nesc_mote] = 0;
