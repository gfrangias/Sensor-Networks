...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f88d6818cf8, const void *arg_0x7f88d6817020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7f88d6797618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f88d654e020), 
int (*key_eq_fn)(void *arg_0x7f88d654e798, void *arg_0x7f88d654ea38));
#line 103
#line 102
int 
...
struct sigevent;
#line 189
extern clock_t clock(void ) __attribute((__leaf__)) __attribute((__nothrow__)) ;
...
static inline void RandomInitialise(int arg_0x7f88d634a610, int arg_0x7f88d634a878);
static double RandomUniform(void );
...
clock_t SRTreeC__epoch_start_time[1000];
...
static inline message_t *SRTreeC__RoutingReceive__receive(message_t *msg, void *payload, uint8_t len)
{
  ...
  sim_log_debug(71U, "SRTreeC", "### RoutingReceive.receive() start ##### \n");
  sim_log_debug(72U, "SRTreeC", "Something received!!! from %u %u\n", __nesc_ntoh_uint16(((RoutingMsg *)payload)->senderID.nxdata), msource);
#line 306
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 306
    {
...
#line 308
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(73U, "SRTreeC", "RoutingMsg enqueue failed!!! \n");
    }
  ...
  sim_log_debug(74U, "SRTreeC", "### RoutingReceive.receive() end ##### \n");
  return msg;
}
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f88d5f9c908, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f88d5f9c908) {
#line 78
    case 22:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f88d5f9c908, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f88d5f9b480, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f88d5f9b480, msg, payload, len);
#line 78
...
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f88d5a43020, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f88d5a43020, addr, msg, len);
#line 80
...
#line 91
{
  ...
  sim_log_debug(178U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] >= 1) {
      ...
      sim_log_debug(179U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(180U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(181U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
  ...
  if (isEmpty) 
    {
      ...
      sim_log_debug(185U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 175
  ...
  sim_log_debug(186U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
...
static inline void SRTreeC__sendRoutingTask__runTask(void )
{
  ...
  if (SRTreeC__RoutingSendQueue__empty()) 
    {
      sim_log_debug(75U, "SRTreeC", "sendRoutingTask(): Q is empty!\n");
  ...
  if (SRTreeC__RoutingSendBusy[sim_node()]) 
    {
      sim_log_debug(76U, "SRTreeC", "sendRoutingTask(): RoutingSendBusy= TRUE!!!\n");
  ...
  if (mlen != sizeof(RoutingMsg )) 
    {
      sim_log_debug(77U, "SRTreeC", "\t\tsendRoutingTask(): Unknown message!!!\n");
  ...
  if (sendDone == SUCCESS) 
    {
      sim_log_debug(78U, "SRTreeC", "sendRoutingTask(): Send returned success!!!\n");
    ...
    {
      sim_log_debug(79U, "SRTreeC", "send failed!!!\n");
    }
}
...
static inline void SRTreeC__receiveRoutingTask__runTask(void )
{
  ...
  sim_log_debug(80U, "SRTreeC", "ReceiveRoutingTask(): len=%u \n", len);
  ...
  if (len == sizeof(RoutingMsg )) 
    {
      ...
      sim_log_debug(81U, "SRTreeC", "receiveRoutingTask():senderID= %d , depth= %d \n", __nesc_ntoh_uint16(mpkt->senderID.nxdata), __nesc_ntoh_uint8(mpkt->depth.nxdata));
      sim_log_debug(82U, "TCT", "receiveRoutingTask():TCT=%d, senderID=%d \n", __nesc_ntoh_uint8(mpkt->tct.nxdata), __nesc_ntoh_uint16(mpkt->senderID.nxdata));
      if (__nesc_ntoh_uint8(mpkt->agg_function.nxdata) == 0) {
          sim_log_debug(83U, "AGGREGATION_FUNCTION", "receiveRoutingTask():Aggregation fuction=MAX, senderID=%d \n", __nesc_ntoh_uint16(mpkt->senderID.nxdata));
        }
      else {
#line 443
        if (__nesc_ntoh_uint8(mpkt->agg_function.nxdata) == 1) {
            sim_log_debug(84U, "AGGREGATION_FUNCTION", "receiveRoutingTask():Aggregation fuction=COUNT, senderID=%d \n", __nesc_ntoh_uint16(mpkt->senderID.nxdata));
          }
        else 
#line 445
          {
            sim_log_debug(85U, "AGGREGATION_FUNCTION", "receiveRoutingTask():Aggregation fuction=MAX&COUNT, senderID=%d \n", __nesc_ntoh_uint16(mpkt->senderID.nxdata));
          }
        }
  ...
  SRTreeC__StartMeasureTimer__startPeriodicAt(-((SRTreeC__curdepth[sim_node()] + 1) * TIMER_VERY_FAST_PERIOD), TIMER_PERIOD_MILLI);
  sim_log_debug(87U, "Measures", "Timer will wait for: %d \n", TIMER_PERIOD_MILLI - (SRTreeC__curdepth[sim_node()] + 1) * TIMER_VERY_FAST_PERIOD);
  sim_log_debug(88U, "Measures", "Measurement for node %d depth %d \n", TOS_NODE_ID, SRTreeC__curdepth[sim_node()]);
}
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f88d5f9d6e8, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f88d5f9d6e8, msg, error);
#line 110
}
#line 110
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f88d5a45e18, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f88d5a45e18) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f88d5a45e18, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f88d6224108){
#line 75
  switch (arg_0x7f88d6224108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f88d6224108);
#line 75
      break;
#line 75
    }
...
#line 269
  ...
  while (list != (void *)0) {
      sim_log_debug(125U, "CpmModelC", "checkReceive: outstanding from %d\n", list->source);
      count++;
  ...
  sim_log_debug(126U, "CpmModelC", "checkReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
...
#line 358
      ...
      sim_log_debug(133U, "CpmModelC,SNRLoss", "-signaling reception\n");
      CpmModelC__Model__receive(mine->msg);
      if (mine->ack) {
          sim_log_debug(134U, "CpmModelC", "yes acknowledgment requested, \n");
        }
      else {
          sim_log_debug(135U, "CpmModelC", "no acknowledgment requested.\n");
        }

      if (mine->ack && CpmModelC__Model__shouldAck(mine->msg)) {
          sim_log_debug(136U, "CpmModelC", " scheduling ack.\n");
          CpmModelC__sim_gain_schedule_ack(mine->source, sim_time() + 1, mine);
        }
      else {
          sim_log_debug(137U, "CpmModelC", " should not ack.\n");
          CpmModelC__free_receive_message(mine);
        }
      ...
      if (RandomUniform() < 0.001) {
          sim_log_debug(138U, "CpmModelC,SNRLoss", "Packet was technically lost, but TOSSIM introduces an ack false positive rate.\n");
          if (mine->ack && CpmModelC__Model__shouldAck(mine->msg)) {
      ...
      CpmModelC__receiving[sim_node()] = 0;
      sim_log_debug_clear(140U, "CpmModelC,SNRLoss", "  -packet was lost.\n");
    }
}
...
#line 407
  ...
  if (!sim_mote_is_on(sim_node())) {
      sim_log_debug(141U, "CpmModelC", "Lost packet from %i due to %i being off\n", source, sim_node());
      rcv->lost = 1;
    }
  else {
#line 430
    if (!CpmModelC__shouldReceive(power - noiseStr)) {
        sim_log_debug(142U, "CpmModelC,SNRLoss", "Lost packet from %i to %i due to SNR being too low (%i)\n", source, sim_node(), (int )(power - noiseStr));
        rcv->lost = 1;
      }
    else {
#line 434
...
#line 437
        if (CpmModelC__receiving[sim_node()]) {
            sim_log_debug(143U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-reception\n", source, sim_node());
            rcv->lost = 1;
          }
        else {
#line 441
          if (CpmModelC__transmitting[sim_node()] && rcv->start < CpmModelC__transmissionEndTime[sim_node()] && CpmModelC__transmissionEndTime[sim_node()] <= rcv->end) {
              sim_log_debug(144U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-transmission, transmissionEndTime %llu\n", source, sim_node(), CpmModelC__transmissionEndTime[sim_node()]);
              rcv->lost = 1;
            }
          else {
...
#line 449
  ...
  while (list != (void *)0) {
      ...
      if (!CpmModelC__shouldReceive(list->power - rcv->power)) {
          sim_log_debug(145U, "Gain,SNRLoss", "Going to lose packet from %i with signal %lf as am receiving a packet from %i with signal %lf\n", list->source, list->power, source, rcv->power);
          list->lost = 1;
        }
      list = list->next;
    }
...
#line 471
  sim_log_debug(146U, "CpmModelC", "Enqueing reception event for %i at %llu with power %lf.\n", dest, endTime, power);
  sim_set_node(dest);
...
#line 480
  ...
  sim_log_debug(147U, "CpmModelC", "Node %i transmitting to %i, finishes at %llu.\n", sim_node(), dest, endTime);
...
#line 487
  ...
  while (list != (void *)0) {
      list->lost = 1;
      sim_log_debug(148U, "CpmModelC,SNRLoss", "Lost packet from %i because %i has outstanding reception, startTime %llu endTime %llu\n", list->source, sim_node(), list->start, list->end);
      list = list->next;
    }
}
...
#line 282
  ...
  sim_log_debug(117U, "TossimPacketModelC", "PACKET: Signaling send done at %llu.\n", sim_time());
...
#line 253
{
  ...
  sim_log_debug(115U, "TossimPacketModelC", "PACKET: Broadcasting packet to everyone.\n");
  ...
  sim_log_debug(116U, "TossimPacketModelC", "PACKET: Send done at %llu.\n", evt->time);
...
#line 243
        TossimPacketModelC__sending[sim_node()] = (void *)0;
        sim_log_debug(114U, "TossimPacketModelC", "PACKET: Failed to send packet due to busy channel.\n");
...
#line 194
  ...
  backoff += sim_csma_init_low();
  backoff *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();
  sim_log_debug(113U, "TossimPacketModelC", "Starting CMSA with %lli.\n", backoff);
...
#line 161
{
  if (!TossimPacketModelC__initialized[sim_node()]) {
      sim_log_error(111U, "TossimPacketModelC", "TossimPacketModelC: Send.send() called, but not initialized!\n");
      return EOFF;
    }
  if (!TossimPacketModelC__running[sim_node()]) {
      sim_log_error(112U, "TossimPacketModelC", "TossimPacketModelC: Send.send() called, but not running!\n");
      return EOFF;
    }
...
#line 244
  sim_log_debug(124U, "CpmModelC,SNR", "SNR is %lf, PRR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
...
#line 299
      ...
      if (msg != TossimPacketModelC__sending[sim_node()]) {
          ...
          sim_log_debug(118U, "TossimPacketModelC", "Requested ack for 0x%x, but outgoing packet is 0x%x.\n", msg, TossimPacketModelC__sending[sim_node()]);
        }
    }
}
...
#line 162
  sim_log_debug(121U, "CpmModelC,SNRLoss", "SNR is %lf, ARR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
  ...
  if (isFull) 
    {
      ...
      sim_log_debug(183U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
...
#line 159
  sim_log_debug(52U, "SRTreeC", "RoutingMsgTimer fired!  radioBusy = %s \n", SRTreeC__RoutingSendBusy[sim_node()] ? "True" : "False");
  ...
  if (TOS_NODE_ID == 0) 
    {
      ...
      sim_log_debug(53U, "Epoch", "##################################### \n");
      sim_log_debug(54U, "Epoch", "#######   ROUND   %u    ############# \n", SRTreeC__roundCounter[sim_node()]);
      sim_log_debug(55U, "Epoch", "#####################################\n");
      SRTreeC__tct[sim_node()] = 5 * (rand() % 4 + 1);
      sim_log_debug(56U, "TCT", "TCT for round %u is %u\n", SRTreeC__roundCounter[sim_node()], SRTreeC__tct[sim_node()]);
      SRTreeC__agg_function[sim_node()] = rand() % 3;

      if (SRTreeC__agg_function[sim_node()] == 0) {
          sim_log_debug(57U, "AGGREGATION_FUNCTION", "Aggregation function for round %u is MAX\n", SRTreeC__roundCounter[sim_node()]);
        }
      else {
#line 178
        if (SRTreeC__agg_function[sim_node()] == 1) {
            sim_log_debug(58U, "AGGREGATION_FUNCTION", "Aggregation function for round %u is COUNT\n", SRTreeC__roundCounter[sim_node()]);
          }
        else 
#line 180
          {
            sim_log_debug(59U, "AGGREGATION_FUNCTION", "Aggregation function for round %u is MAX&COUNT\n", SRTreeC__roundCounter[sim_node()]);
          }
        }
#line 183
...
static inline void SRTreeC__StartMeasureTimer__fired(void )
{
  ...
  sim_log_debug(89U, "Measures", "Measurement in depth %d: %d\n", SRTreeC__curdepth[sim_node()], SRTreeC__meas[sim_node()]);
...
static inline void SRTreeC__NewEpochTimer__fired(void )
{
  ...
  sim_log_debug(65U, "Epoch", "##################################### \n");
  sim_log_debug(66U, "Epoch", "#######   ROUND   %u    ############# \n", SRTreeC__roundCounter[sim_node()]);
  sim_log_debug(67U, "Epoch", "#####################################\n");
}
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f88d5ae8da0){
#line 83
  switch (arg_0x7f88d5ae8da0) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f88d5ae8da0);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(177U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP__compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP__overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(176U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP__overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(173U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(174U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(166U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(156U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 225
  sim_log_debug(163U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 45
{
  sim_log_debug(90U, "PlatformC", "Initialized mote.\n");
  return SUCCESS;
}
...
#line 86
{
  sim_log_debug(106U, "TossimPacketModelC", "TossimPacketModelC: Init.init() called\n");
...
#line 364
{
  sim_log_debug(168U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
static inline void SRTreeC__Boot__booted(void )
{
  SRTreeC__epoch_start_time[sim_node()] = clock();
  sim_log_debug(46U, "Measures", "Time %d\n", clock());
  srand(time(0));
  SRTreeC__RadioControl__start();
...
#line 294
  noise = pow(10.0, noise / 10.0);
  while (list != (void *)0) {
      sim_log_debug(127U, "CpmModelC", "packetReceive: outstanding from %d\n", list->source);
      count++;
  ...
  noise = 10.0 * log(noise) / log(10.0);
  sim_log_debug(128U, "CpmModelC", "packetReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
  return noise;
}
...
#line 131
{
  ...
  sim_log_debug(119U, "CpmModelC", "IN: noise_hash_generation()\n");
  ...
  sim_log_debug(120U, "CpmModelC,Tal", "%s: OUT: noise_hash_generation(): %lf\n", sim_time_string(), noise_val);
...
#line 285
  ...
  sim_log_debug(165U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(171U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 101
      sim_log_debug(151U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) {
              sim_log_debug(152U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(153U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__set[sim_node()]) {
          ...
          sim_log_debug(154U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(172U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(175U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(164U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
...
{
  if (!TossimPacketModelC__initialized[sim_node()]) {
      sim_log_error(107U, "TossimPacketModelC", "TossimPacketModelC: Control.start() called before initialization!\n");
      return FAIL;
    }
  sim_log_debug(108U, "TossimPacketModelC", "TossimPacketModelC: Control.start() called.\n");
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "SRTreeC__epoch_start_time"))
  {
    *addr = (uintptr_t)&SRTreeC__epoch_start_time[__nesc_mote];
    *size = sizeof(SRTreeC__epoch_start_time[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&SRTreeC__epoch_start_time[__nesc_mote], 0, sizeof SRTreeC__epoch_start_time[__nesc_mote]);
