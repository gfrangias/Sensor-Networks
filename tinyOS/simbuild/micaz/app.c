...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f83b95a7cf8, const void *arg_0x7f83b95a6020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7f83b9526618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f83b92dd020), 
int (*key_eq_fn)(void *arg_0x7f83b92dd798, void *arg_0x7f83b92dda38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f83b90d9610, int arg_0x7f83b90d9878);
static double RandomUniform(void );
  ...
  if (isFull) 
    {
      ...
      sim_log_debug(282U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f83b8c9e908, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f83b8c9e908) {
#line 78
    case 12:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f83b8c9e908, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f83b8c9c480, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f83b8c9c480, msg, payload, len);
#line 78
  ...
  if (len == sizeof(RoutingMsg )) 
    {
      ...
      sim_log_debug(94U, "SRTreeC", "***********************************************\nreceiveRoutingTask():senderID= %d , depth= %d \n", __nesc_ntoh_uint16(mpkt->senderID.nxdata), __nesc_ntoh_uint8(mpkt->depth.nxdata));
      sim_log_debug(95U, "TCT", "receiveRoutingTask():TCT=%d, senderID=%d \n", __nesc_ntoh_uint8(mpkt->tct.nxdata), __nesc_ntoh_uint16(mpkt->senderID.nxdata));
      if (__nesc_ntoh_uint8(mpkt->agg_function.nxdata) == 0) {
          sim_log_debug(96U, "AGGREGATION_FUNCTION", "receiveRoutingTask():Aggregation fuction=MAX, senderID=%d \n", __nesc_ntoh_uint16(mpkt->senderID.nxdata));
        }
      else {
#line 805
        if (__nesc_ntoh_uint8(mpkt->agg_function.nxdata) == 1) {
            sim_log_debug(97U, "AGGREGATION_FUNCTION", "receiveRoutingTask():Aggregation fuction=COUNT, senderID=%d \n", __nesc_ntoh_uint16(mpkt->senderID.nxdata));
          }
        else 
#line 807
          {
            sim_log_debug(98U, "AGGREGATION_FUNCTION", "receiveRoutingTask():Aggregation fuction=MAX&COUNT, senderID=%d \n", __nesc_ntoh_uint16(mpkt->senderID.nxdata));
          }
        }
      ...
      if (SRTreeC__parentID[sim_node()] < 0 || SRTreeC__parentID[sim_node()] >= 65535) 
        {
          ...
          sim_log_debug(99U, "NotifyParentMsg", "receiveRoutingTask():NotifyParentMsg sending to node= %d... \n", SRTreeC__parentID[sim_node()]);
          ...
          if (SRTreeC__curdepth[sim_node()] > __nesc_ntoh_uint8(mpkt->depth.nxdata) + 1 || __nesc_ntoh_uint16(mpkt->senderID.nxdata) == SRTreeC__parentID[sim_node()]) 
            {
              ...
              sim_log_debug(101U, "SRTreeC", "NotifyParentMsg sending to node= %d... \n", oldparentID);
              ...
              if ((oldparentID < 65535 || oldparentID > 0) || oldparentID == SRTreeC__parentID[sim_node()]) 
                {
                  ...
                  if (SRTreeC__NotifySendQueue__enqueue(tmp) == SUCCESS) 
                    {
                      sim_log_debug(102U, "SRTreeC", "receiveRoutingTask(): NotifyParentMsg enqueued in SendingQueue successfully!!!\n");
              ...
              if (oldparentID != SRTreeC__parentID[sim_node()]) 
                {
                  ...
                  __nesc_hton_uint8(m->depth.nxdata, SRTreeC__curdepth[sim_node()]);
                  __nesc_hton_uint16(m->parentID.nxdata, SRTreeC__parentID[sim_node()]);
                  sim_log_debug(103U, "SRTreeC", "receiveRoutingTask():NotifyParentMsg sending to node= %d... \n", SRTreeC__parentID[sim_node()]);
                  ...
                  if (SRTreeC__NotifySendQueue__enqueue(tmp) == SUCCESS) 
                    {
                      sim_log_debug(104U, "SRTreeC", "receiveRoutingTask(): NotifyParentMsg enqueued in SendingQueue successfully!!! \n");
    ...
    {
      sim_log_debug(105U, "SRTreeC", "receiveRoutingTask():Empty message!!! \n");
...
#line 82
{
  sim_log_debug(173U, "Serial", "Serial: sending a packet of size %d\n", len);
  return FAIL;
}

# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__send(am_id_t arg_0x7f83b853fc70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = SerialActiveMessageC__AMSend__send(arg_0x7f83b853fc70, addr, msg, len);
#line 80
...
#line 91
{
  ...
  sim_log_debug(265U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__current[sim_node()] >= 1) {
      ...
      sim_log_debug(266U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(267U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(268U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
  ...
  if (isEmpty) 
    {
      ...
      sim_log_debug(284U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 175
  ...
  sim_log_debug(285U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
...
static inline void SRTreeC__receiveNotifyTask__runTask(void )
{
  ...
  sim_log_debug(106U, "SRTreeC", "ReceiveNotifyTask(): len=%u \n", len);
  ...
  if (len == sizeof(NotifyParentMsg )) 
    {
      ...
      sim_log_debug(107U, "SRTreeC", "NotifyParentMsg received from %d !!! \n", __nesc_ntoh_uint16(mr->senderID.nxdata));
...
#line 1012
              ...
              sim_log_debug(108U, "Serial", "Sending NotifyParentMsg to PC... \n");
...
#line 1030
          ...
          sim_log_debug(109U, "SRTreeC", "Forwarding NotifyParentMsg from senderID= %d  to parentID=%d \n", __nesc_ntoh_uint16(m->senderID.nxdata), SRTreeC__parentID[sim_node()]);
          ...
          if (SRTreeC__NotifySendQueue__enqueue(tmp) == SUCCESS) 
            {
              sim_log_debug(110U, "SRTreeC", "receiveNotifyTask(): NotifyParentMsg enqueued in SendingQueue successfully!!!\n");
              if (SRTreeC__NotifySendQueue__size() == 1) 
                {
                  SRTreeC__sendNotifyTask__postTask();
                }
    ...
    {
      sim_log_debug(111U, "SRTreeC", "receiveNotifyTask():Empty message!!! \n");
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f83b8c9f6e8, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f83b8c9f6e8, msg, error);
#line 110
}
#line 110
...
#line 531
  ...
  sim_log_debug(172U, "CpmModelC", "ReadRssi: noise %f\n", noise);
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f83b8540990, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f83b8540990) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f83b8540990, msg, error);
#line 100
      break;
#line 100
    }
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__sendDone(uint8_t arg_0x7f83b8540990, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f83b8540990) {
#line 100
    case 0U:
...
#line 100
    default:
#line 100
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__default__sendDone(arg_0x7f83b8540990, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f83b8fb3108){
#line 75
  switch (arg_0x7f83b8fb3108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f83b8fb3108);
#line 75
      break;
#line 75
    }
...
{
  LedsP__Led2__clr();
  sim_log_debug(182U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP__Led2__get() ? "off" : "on");
#line 106
  ;
}
...
{
  LedsP__Led1__clr();
  sim_log_debug(179U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP__Led1__get() ? "off" : "on");
#line 91
  ;
}
...
{
  LedsP__Led0__clr();
  sim_log_debug(176U, "LedsC", "LEDS: Led""0"" %s.\n", LedsP__Led0__get() ? "off" : "on");
#line 76
  ;
}
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f83b853fc70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f83b853fc70, addr, msg, len);
#line 80
...
#line 269
  ...
  while (list != (void *)0) {
      sim_log_debug(147U, "CpmModelC", "checkReceive: outstanding from %d\n", list->source);
      count++;
  ...
  sim_log_debug(148U, "CpmModelC", "checkReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
...
#line 321
{
  ...
  sim_log_debug(151U, "CpmModelC", "Handling reception event @ %s.\n", sim_time_string());
  while (list != (void *)0) {
      if (list->next == mine) {
          predecessor = list;
        }
...
#line 336
    if (mine == CpmModelC__outstandingReceptionHead[sim_node()]) {
        ...
        sim_log_error(152U, "CpmModelC", "Incoming packet list structure is corrupted: entry is not the head and no entry points to it.\n");
      }
    }
#line 342
  sim_log_debug(153U, "CpmModelC,SNRLoss", "Packet from %i to %i\n", (int )mine->source, (int )sim_node());
  if (!CpmModelC__checkReceive(mine)) {
      sim_log_debug(154U, "CpmModelC,SNRLoss", " - lost packet from %i as SNR was too low.\n", (int )mine->source);
      mine->lost = 1;
    }
...
#line 358
      ...
      sim_log_debug(155U, "CpmModelC,SNRLoss", "-signaling reception\n");
      CpmModelC__Model__receive(mine->msg);
      if (mine->ack) {
          sim_log_debug(156U, "CpmModelC", "yes acknowledgment requested, \n");
        }
      else {
          sim_log_debug(157U, "CpmModelC", "no acknowledgment requested.\n");
        }

      if (mine->ack && CpmModelC__Model__shouldAck(mine->msg)) {
          sim_log_debug(158U, "CpmModelC", " scheduling ack.\n");
          CpmModelC__sim_gain_schedule_ack(mine->source, sim_time() + 1, mine);
        }
      else {
          sim_log_debug(159U, "CpmModelC", " should not ack.\n");
          CpmModelC__free_receive_message(mine);
        }
...
{
  LedsP__Led0__set();
  sim_log_debug(177U, "LedsC", "LEDS: Led""0"" %s.\n", LedsP__Led0__get() ? "off" : "on");
#line 81
  ;
}
...
#line 55
{
  sim_log_debug(186U, "Pins", "Setting bit %i of port %i.\n", (int )1, (int )27U);
  atm128RegFile[sim_node()][27U] |= 1 << 1;
}
...
{
  LedsP__Led1__set();
  sim_log_debug(180U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP__Led1__get() ? "off" : "on");
#line 96
  ;
}
...
#line 55
{
  sim_log_debug(185U, "Pins", "Setting bit %i of port %i.\n", (int )0, (int )27U);
  atm128RegFile[sim_node()][27U] |= 1 << 0;
}
...
{
  LedsP__Led2__set();
  sim_log_debug(183U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP__Led2__get() ? "off" : "on");
#line 111
  ;
}
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f83b85f1da0){
#line 83
  switch (arg_0x7f83b85f1da0) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f83b85f1da0);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(259U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP__compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP__overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(258U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP__overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(255U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(256U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(248U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(238U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 225
  sim_log_debug(245U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 45
{
  sim_log_debug(112U, "PlatformC", "Initialized mote.\n");
  return SUCCESS;
}
...
#line 364
{
  sim_log_debug(250U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 285
  ...
  sim_log_debug(247U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(253U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 294
  noise = pow(10.0, noise / 10.0);
  while (list != (void *)0) {
      sim_log_debug(149U, "CpmModelC", "packetReceive: outstanding from %d\n", list->source);
      count++;
  ...
  noise = 10.0 * log(noise) / log(10.0);
  sim_log_debug(150U, "CpmModelC", "packetReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
  return noise;
}
...
#line 101
      sim_log_debug(233U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) {
              sim_log_debug(234U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(235U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__set[sim_node()]) {
          ...
          sim_log_debug(236U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(254U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(257U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(246U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
...
#line 91
{
  ...
  sim_log_debug(260U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] >= 2) {
      ...
      sim_log_debug(261U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(262U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
          /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] = 2;
      ...
      sim_log_debug(263U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
